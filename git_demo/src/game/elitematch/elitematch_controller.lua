...
function ElitematchController:loginSendProtoInfo()
    ...
    if is_open then
        ...
        elseif limit_type == 2 then -- 世界等级不足
            EventManager:getInstance():Bind(RoleEvent.WORLD_LEV,self,function()
                local is_open = self.model:checkElitematchIsOpen(true)
                if is_open then
                    self.is_check_redpoint = true
                    self.model:setUpdateRedPoint(false)
...
function ElitematchController:handle24900(data)
    ...
    EventManager:getInstance():Fire(ElitematchEvent.Get_Elite_Main_Info_Event, data)
...
function ElitematchController:handle24901(data)
    EventManager:getInstance():Fire(ElitematchEvent.Get_Elite_Enemy_Info_Event, data)
...
function ElitematchController:handle24903(data)
    if data.code == TRUE then
        ...
        message(data.msg)
        EventManager:getInstance():Fire(ElitematchEvent.Elite_Fight_Fail_Event)
    end
end
--购买次数
...
function ElitematchController:handle24904(data)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ElitematchEvent.Elite_buy_count_Event, data)
    else
        message(data.msg)
    end
end
...
function ElitematchController:handle24905(data)
    ...
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Start_Time_Event, data)
    self.model:setSCDataBack24905()
end

--战斗结算
function ElitematchController:handle24906(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Fight_Result_Event)
    ...
    self.timer_id = GlobalTimeTicket:getInstance():add(function(dt)
        self.timer_id = nil
...
function ElitematchController:handle24910(data)
    -- if data.code == TRUE then
    EventManager:getInstance():Fire(ElitematchEvent.Elite_History_Zone_Event, data)
    -- else
    --     message(data.msg)
    -- end
end
...
function ElitematchController:handle24911(data)
    -- if data.code == TRUE then
    EventManager:getInstance():Fire(ElitematchEvent.Elite_History_Record_Event, data)
    -- else
    --     message(data.msg)
    -- end
end
...
function ElitematchController:handle24915(data)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ElitematchEvent.Elite_Receive_Reward_Event, data)
    else
        message(data.msg)
    end
end
...
function ElitematchController:handle24920(data)
    ...
    EventManager:getInstance():Fire(ElitematchEvent.Update_Elite_Fun_Form, data)
...
function ElitematchController:handle24921(data)
    ...
    if data.code == TRUE then
        EventManager:getInstance():Fire(ElitematchEvent.Update_Elite_Save_Form, data)
        self:sender24920(1)
        self:sender24920(2)
    else
        message(data.msg)
...
function ElitematchController:handle24930(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Challenge_Record_Event, data)
end
...
function ElitematchController:handle24931(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Challenge_Record_Info_Event, data)
end
...
function ElitematchController:handle24940(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Personal_Info_Event, data)
end
...
function ElitematchController:handle24942(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Personal_Info_Event2, data)
end
...
function ElitematchController:handle24945(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_Declaration_Event, data)
end
...
function ElitematchController:handle24952(data)
    ...
    EventManager:getInstance():Fire(ElitematchEvent.Elite_OrderAction_Init_Event, data)
end
...
function ElitematchController:handle24954(data)
    ...
    EventManager:getInstance():Fire(ElitematchEvent.Elite_OrderAction_First_Red_Event)
end
...
function ElitematchController:handle24955(data)
    EventManager:getInstance():Fire(ElitematchEvent.Elite_OrderAction_IsPopWarn_Event,data)
end
