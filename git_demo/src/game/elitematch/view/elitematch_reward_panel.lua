...
function ElitematchRewardItem:setData(data, tab_index)
    ...
    if tab_index == 3 then
        ...
        if data.id == 1 then
            local res = PathTool.getResFrame("common","hl_common_2000")
            loadSpriteTexture(self.icon, res, LOADTEXT_TYPE_PLIST)
        elseif data.id == 2 then
            local res = PathTool.getResFrame("common","hl_common_2001")
            loadSpriteTexture(self.icon, res, LOADTEXT_TYPE_PLIST)
        elseif data.id == 3 then
            local res = PathTool.getResFrame("common","hl_common_2002")
            loadSpriteTexture(self.icon, res, LOADTEXT_TYPE_PLIST)
        else
