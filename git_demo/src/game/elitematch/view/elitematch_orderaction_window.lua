...
function ElitematchOrderactionWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/elitematch","elitematch_main_bg",true), type = ResourcesType.single},
    }
...
function ElitematchOrderactionWindow:open_callback()
    ...
    if self.background ~= nil then
    	self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/elitematch","elitematch_main_bg",true), LOADTEXT_TYPE)
    end
...
function ElitematchOrderActiodRewardItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("elitematch/elitematch_orderaction_reward_item"))
