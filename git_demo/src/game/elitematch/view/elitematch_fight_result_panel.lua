...
function ElitematchFightResultPanel:open_callback()
    ...
    self.comfirm_btn = createTypeButton(self.container,TI18N("确定"), 620, 580, ButtonType.yellow)
    ...
    self.cancel_btn = createTypeButton(self.container,TI18N("返回玩法"), 620, 580, ButtonType.red)
