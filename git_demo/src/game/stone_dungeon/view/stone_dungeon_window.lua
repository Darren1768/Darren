...
function StoneDungeonWindow:open_callback()
    ...
    local bg_top = PathTool.getSingleImgForDownLoad("activity/activity_big", "activity_top")
...
function StoneDungeonWindow:setLoadBanner(id)
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("activity/activity_big", str)
...
function StoneDungeonTab:setData(data)
    ...
    local res = PathTool.getSingleImgForDownLoad("activity/activity_tab", "activity_tab_"..data.id)
