...
HeroConst.CampName = { --水火风光暗
    ...
    [HeroConst.CampType.eWater]         = TI18N("人") , --无
    [HeroConst.CampType.eFire]          = TI18N("神") , --无
    [HeroConst.CampType.eWind]          = TI18N("妖") , --无
    [HeroConst.CampType.eLight]         = TI18N("佛") , --无
    [HeroConst.CampType.eDark]          = TI18N("魔") , --无
}
--英雄阵营对应属性名字
