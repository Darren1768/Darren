...
function HeroDrawMainWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/hero", "hero_draw_bg", true), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("bigbg/hero", "hero_draw_bg_2", false), type = ResourcesType.single}
    }
...
function HeroDrawMainWindow:open_callback()
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/hero", "hero_draw_bg", true), LOADTEXT_TYPE)
    ...
    loadSpriteTexture(self.bottom_bg, PathTool.getSingleImgForDownLoad("bigbg/hero", "hero_draw_bg_2", false), LOADTEXT_TYPE)
...
function HeroDrawMainWindow:initHeroDraw( use_skin)
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("herodraw/herodrawres",draw_res, false)
