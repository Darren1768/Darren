...
function HeroClothesLustratTab:configUI()
	self.root_wnd = createCSBNote(PathTool.getTargetCSB("hero/hero_clothes_lustrat_tab"))
...
function HeroClothesLustratItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("hero/hero_clothes_lustrat_item"))
    self:addChild(self.root_wnd)
