...
function ArtifactRecastCostPanel:register_event()
    registerButtonEventListener(self.close_btn, function() 
        EventManager:getInstance():Fire(HeroEvent.Artifact_Cost_Select_Event)
    ...
    registerButtonEventListener(self.cost_btn_1, function() 
        EventManager:getInstance():Fire(HeroEvent.Artifact_Cost_Select_Event, 1)
        self.ctrl:openArtifactRecastCostPanel(false)
    end, true, 1)

    registerButtonEventListener(self.cost_btn_2, function() 
        EventManager:getInstance():Fire(HeroEvent.Artifact_Cost_Select_Event, 2)
        self.ctrl:openArtifactRecastCostPanel(false)
    end, true, 1)
end
