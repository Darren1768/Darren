...
function HeroResonateTabEmpowermentPanel:registerEvents()
    ...
    registerButtonEventListener(self.look_btn, function(param,sender, event_type) 
     ...
     --共鸣赋能返回
     EventManager:getInstance():Bind(HeroEvent.Hero_Resonate_Empowerment_Event,self, function(data)
            if not data then return end
            self:setScdata(data)
        end)
    --共鸣赋能成功返回
     EventManager:getInstance():Bind(HeroEvent.Hero_Resonate_Empowerment_Success_Event,self, function(data)
    ...
    --共鸣赋能成功返回
     EventManager:getInstance():Bind(HeroEvent.Hero_Resonate_Skill_List_Event,self, function(data)
            if not data then return end
            self.dic_had_skill = {}
     ...
     --添加英雄选择返回事件
     EventManager:getInstance():Bind(HeroEvent.Select_Hero_Event,self, function(dic_cur_select_list, form_type)
     ...
     --添加技能返回
     EventManager:getInstance():Bind(HeroEvent.Hero_Resonate_Select_Skill_Event,self, function(pos, skill_id)
            if pos then
     ...
     --战力显示
     EventManager:getInstance():Bind(HeroEvent.Hero_Resonate_Hero_Power_Event,self, function(data)
            if not data then return end
