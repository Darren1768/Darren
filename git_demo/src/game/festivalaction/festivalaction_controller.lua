...
function FestivalActionController:handle25700(data)
    ...
    EventManager:getInstance():Fire(FestivalActionEvent.TreasureMessage,data)
end
...
function FestivalActionController:handle25702(data)
    EventManager:getInstance():Fire(FestivalActionEvent.Treasure_OpenStatus_Event,data)
end
...
function FestivalActionController:handle25703(data)
    EventManager:getInstance():Fire(FestivalActionEvent.Treasure_AllServer_Event,data)
end
...
function FestivalActionController:handle25704(data)
    EventManager:getInstance():Fire(FestivalActionEvent.Treasure_MyServer_Event,data)
end
...
function FestivalActionController:handle26300(data)
    EventManager:getInstance():Fire(FestivalActionEvent.Personal_Gift_Event,data)
end
