...
function EndlessOpenTips:__init()
    ...
    self.res_list = {
		{path = PathTool.getSingleImgForDownLoad("endless","endless_bg_1"), type = ResourcesType.single },
	}
end
...
function EndlessOpenTips:setData( )
    ...
    local res = PathTool.getSingleImgForDownLoad("endless", "icon_"..type_conf.icon, false)
