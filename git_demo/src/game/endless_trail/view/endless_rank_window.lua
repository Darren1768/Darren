...
function EndlessRankWindow:__init(type,endless_type )
...
function EndlessRankWindow:openRootWnd(type,endless_type)
    print("-------------openRootWnd-----------------",type )
...
function EndlessRankWindow:changeSelectedTab(index)
    ...
    if self.cur_panel == nil then
        if index == Endless_trailEvent.type.rank then
            ...
            self.cur_panel:setPosition(cc.p(16 ,4))
