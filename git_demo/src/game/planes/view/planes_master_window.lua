...
function PlanesMasterWindow:__init()
    ...
    self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("planes","big_bg_2"), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("planes","big_bg_3"), type = ResourcesType.single},
	}
