...
function ArenateamController:registerEvents()
    ...
    --聊天那边会影响这边的红点
    EventManager:getInstance():Bind(EventId.CHAT_UDMSG_WORLD,self, function(channel, is_self, is_login_content)
    ...
    EventManager:getInstance():Bind(ArenateamEvent.ARENATEAM_REFRESH_TEAM_INFO_EVENT,self, function()
        --没保存布阵一
...
function ArenateamController:handle27220(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_MAIN_EVENT, data)
end

function ArenateamController:handle27227(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_ONLINE_EVENT, data)
end
...
function ArenateamController:handle27200(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_HALL_MAIN_EVENT, data)
end
...
function ArenateamController:handle27202(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_APPLY_TEAM_EVENT, data)
    end
end
...
function ArenateamController:handle27203(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_APPLY_LIST_EVENT, data)
end
...
function ArenateamController:handle27204(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_ANSWER_APPLY_EVENT, data)
    end
end
...
function ArenateamController:handle27205(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_INVITATION_PLAYER_EVENT, data)
    end
end
...
function ArenateamController:handle27206(data)
    ...
    -- end
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_INVITATION_LIST_EVENT, data)
end
...
function ArenateamController:handle27208(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_KEY_CLEAR_EVENT, data)
    end
end
...
function ArenateamController:handle27210(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_SEARCH_TEAM_EVENT, data)
    end
end
...
function ArenateamController:handle27216(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_KEY_APPLY_TEAM_EVENT, data)
    end
end
...
function ArenateamController:handle27221(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_MY_TEAM_INFO_EVENT, data)
end
...
function ArenateamController:newApply()
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_APPLY_RED_POINT_EVENT)
end

--推送新的入队邀请
function ArenateamController:newInvitation(data)
    self.model:setIsInvitationRedpoint(true)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_INVITATION_RED_POINT_EVENT)
end
...
function ArenateamController:handle27223(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_MAIN_RANK_EVENT, data)  
end
--领取奖励
...
function ArenateamController:handle27224(data)
    if data.code == TRUE then
        ...
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_RECEIVE_BOX_EVENT, data)
    end
end
--修改队伍设置
...
function ArenateamController:handle27225(data)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_TEAM_SET_EVENT, data)
...
function ArenateamController:handle27226(data)
    if data.code == TRUE then
        ...
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_CHANGE_NAME_EVENT, data)
    else
        message(data.msg)
    end
end
...
function ArenateamController:handle27228(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_GET_RECOMMEND_INFO_EVENT, data)
end
...
function ArenateamController:handle27229(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_SEARCH_PLAYER_EVENT, data)
end
...
function ArenateamController:handle27240(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_JOIN_GAME_EVENT, data)    
    end
end
...
function ArenateamController:handle27241(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_LEAVE_GAME_EVENT, data)    
    end
end
...
function ArenateamController:handle27242(data)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_SAVE_FROM_EVENT, data) 
        self:sender27221()
    else
        message(data.msg)  
    end
...
function ArenateamController:handle27243(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_THREE_TEAM_INFO_EVENT, data)    
end
...
function ArenateamController:handle27251(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_MATCH_OTHER_EVENT, data)    
end
...
function ArenateamController:handle27255(data)
    ...
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_MIAIN_REPORT_EVENT, data)
end
...
function ArenateamController:handle27256(data)
    EventManager:getInstance():Fire(ArenateamEvent.ARENATEAM_SINGLE_REPORT_EVENT, data)
end
