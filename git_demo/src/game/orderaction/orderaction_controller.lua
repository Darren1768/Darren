...
function OrderActionController:handle25300(data)
    ...
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_Init_Event,data)
end

--任务更新
function OrderActionController:handle25301(data)
    self.model:updataTeskData(data)
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_TaskGet_Event)
end
--提交任务
...
function OrderActionController:handle25303(data)
    ...
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_LevReward_Event,data.lev)
end
--领取等级奖励
...
function OrderActionController:handle25305(data)
    ...
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_Updata_LevExp_Event,data)
end
...
function OrderActionController:handle25306(data)
    ...
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_BuyGiftCard_Event)
end
...
function OrderActionController:handle25309(data)
    EventManager:getInstance():Fire(OrderActionEvent.OrderAction_IsPopWarn_Event,data)
end
