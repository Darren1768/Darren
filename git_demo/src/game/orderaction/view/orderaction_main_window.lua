...
function OrderActionMainWindow:open_callback()
    ...
    self.btn_open_lock:loadTexture(PathTool.getResFrame("common", "hl_common_4"), LOADTEXT_TYPE_PLIST)
    --购买等级
...
function OrderActionMainWindow:tabMainPeriodView()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_top" .. cur_period ) or nil
    local botton_res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_buttom" .. cur_period ) or nil
