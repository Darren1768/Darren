...
function OrderActionTeskPanel1:layoutUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("orderaction/tesk_panel1"))
...
function OrderActionTeskPanel1:registerEvents()
     EventManager:getInstance():Bind(OrderActionEvent.OrderAction_TaskGet_Event,self,function()
            self:setTaskGetStatus()
            self:setTabRedPoint()
        end)
...
function OrderActionTeskItem1:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("orderaction/tesk_item1"))
