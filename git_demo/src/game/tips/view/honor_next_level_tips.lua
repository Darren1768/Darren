...
function HonorNextLevelTips:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg", "txt_cn_honor_level_bg_1")
...
function HonorNextLevelTips:openRootWnd(setting)
    ...
    if show_type ==  RoleConst.role_type.eOther then
        ...
        local res = PathTool.getSingleImgForDownLoad("rolehonorwall/honorwarllicon", "honor_level_"..next_res_id, false)
