...
function PartnerSummonWindow:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_11",true), type = ResourcesType.single },
    }
...
function PartnerSummonWindow:open_callback()
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg","bigbg_11",true), LOADTEXT_TYPE)
