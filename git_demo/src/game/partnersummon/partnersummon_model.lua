...
function PartnersummonModel:setSummonData(data)
    if data then
        ...
        EventManager:getInstance():Fire(PartnersummonEvent.updateSummonDataEvent, data)
    end
end
--五星的英雄10之内是否出来
...
function PartnersummonModel:updateRecruitData( dataList )
    ...
    EventManager:getInstance():Fire(PartnersummonEvent.updateSummonSingleDataEvent, group_ids)
end
...
function PartnersummonModel:setShareData(data)
    if data then
        ...
        EventManager:getInstance():Fire(PartnersummonEvent.updateSummonShareDataEvent, data)
    end
end
