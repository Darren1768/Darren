...
function PlanesafkController:registerEvents()
     EventManager:getInstance():Bind(MainuiEvent.CLOSE_ITEM_VIEW,self, function(data)
...
function PlanesafkController:handle28600( data )
    ...
    if data.code == TRUE and self.evt_extend and self.evt_extend.data and 
        ...
        if self.evt_extend.buff_id and self.evt_extend.world_pos then -- 选择buff成功，播放飘动动画
            EventManager:getInstance():Fire(PlanesafkEvent.Chose_Buff_Event, self.evt_extend.buff_id, self.evt_extend.world_pos)
...
function PlanesafkController:handle28602( data )
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Main_Base_Info_Event, data)
end
...
function PlanesafkController:handle28603( data )
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Main_Map_Info_Event, data)
end


--领取奖励更新
function PlanesafkController:handle28624( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Last_Reward_Info_Event, data)
end
...
function PlanesafkController:handle28625( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Update_Get_Reward_Event, data)
end
-- 进入下一层
...
function PlanesafkController:handle28604( data )
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Next_Map_Info_Event, data)
    end
end
...
function PlanesafkController:handle28605( data )
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Pass_Reward_Info_Event, data)
    end
end
...
function PlanesafkController:handle28606( data )
    self.model:updateRolePos(data)
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_Update_Map_Info_Event, data)
end

-- 对方阵容数据
function PlanesafkController:handle28607( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Get_Master_Data_Event, data)
end
...
function PlanesafkController:handle28610( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Update_Form_Atk_Event, data.power)
end
...
function PlanesafkController:handle28611( data )
    ...
    if data.flag == 1 then
        EventManager:getInstance():Fire(PlanesafkEvent.Save_Form_Success_Event) 
    end
end
...
function PlanesafkController:handle28612( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Get_Form_Data_Event, data) 
end
...
function PlanesafkController:handle28613( data )
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Get_All_Hero_Event)
end
...
function PlanesafkController:handle28620( data )
    EventManager:getInstance():Fire(PlanesafkEvent.Get_Buff_Data_Event, data.buffs)
end
...
function PlanesafkController:handle28621( data )
    if self.planesafk_evt_shop_panel then
        EventManager:getInstance():Fire(PlanesafkEvent.Evt_Shop_Event, data)
    else
...
function PlanesafkController:handle28623( data )
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Look_Other_Hero_Event, data)
end
...
function PlanesafkController:handle28616(data)
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_OrderAction_Init_Event, data)
end
...
function PlanesafkController:handle28618(data)
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_OrderAction_First_Red_Event)
end
...
function PlanesafkController:handle28619(data)
    EventManager:getInstance():Fire(PlanesafkEvent.Planesafk_OrderAction_IsPopWarn_Event,data)
end
