...
function PlanesafkModel:updateMyHeroData( data_list )
    ...
    EventManager:getInstance():Fire(PlanesafkEvent.Get_Hero_Live_Event)
...
function PlanesafkModel:checkPlanesafkRedPoint()
    ...
    GhostdomController:getInstance():setBuildRedStatus(GhostdomConst.Build_Type.ghostdom, {bid = 1, status = is_show_red})
    EventManager:getInstance():Fire(PlanesafkEvent.Update_Planes_Red_Event)
end
