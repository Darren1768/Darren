...
function ActionyearmonsterController:handle28200( data )
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.YEAR_MONSTER_BASE_INFO, data)
...
function ActionyearmonsterController:handle28201( data )
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.YEAR_MONSTER_CEIL_INFO, data)
end
--格子数据更新
function ActionyearmonsterController:handle28218(data)
    if next(data.tile_list) ~= nil then
        ...
        EventManager:getInstance():Fire(ActionyearmonsterEvent.YEAR_UPDATE_GRID_EVENT, data.tile_list)
    end
end
...
function ActionyearmonsterController:handle28202( data )
    message(data.msg)
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Update_Role_Grid_Event, data)
end
...
function ActionyearmonsterController:handle28203( data )
    ...
    if data.code == TRUE and self.evt_extend and self.evt_extend.index == data.index then
        ...
        --     EventManager:getInstance():Fire(PlanesEvent.Chose_Buff_Event, self.evt_extend.buff_id, self.evt_extend.world_pos)
...
function ActionyearmonsterController:handle28204( data )
    ...
    if data.flag == TRUE then
        ...
        --     EventManager:getInstance():Fire(PlanesEvent.Dun_Open_Effect_Event, data)
        -- else
...
function ActionyearmonsterController:handle28210( data )
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Get_Master_Data_Event, data)
end
...
function ActionyearmonsterController:handle28211( data )
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Submit_item_Event, data)
    end
end
...
function ActionyearmonsterController:handle28212( data )
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Buy_count_Event, data)
    end
end
...
function ActionyearmonsterController:handle28213( data )
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Rank_Info_Event, data)
end
...
function ActionyearmonsterController:handle28217(data)
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.UPDATE_EXCHANGE_DATA_EVENT)
end
...
function ActionyearmonsterController:handle28220(data)
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Face_Event, data)
end
...
function ActionyearmonsterController:handle28221(data)
    message(data.msg)
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Five_Effect_Event,data)    
end
...
function ActionyearmonsterController:handle28222(data)
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Other_Role_Event, data)    
end
...
function ActionyearmonsterController:handle28223(data)
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Update_Year_Main_Redbag_Event, data.flag)    
end
