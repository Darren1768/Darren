...
function ActionyearmonsterExchangeWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster","actionyearmonster_exchang_bg"), type = ResourcesType.single }
    }
...
function ActionyearmonsterExchangeWindow:loadBannerImage()
    -- 横幅图片
    local res = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster", "actionyearmonster_exchang_bg")
...
function ActionyearmonsterExchangeWindow:register_event()
     EventManager:getInstance():Bind(ActionyearmonsterEvent.UPDATE_EXCHANGE_DATA_EVENT,self,function()
...
function ActionyearmonsterExchangeItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("actionyearmonster/actionyearmonster_exchange_item"))
