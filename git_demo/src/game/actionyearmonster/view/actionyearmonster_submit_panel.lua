...
function ActionyearmonsterSubmitPanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster","actionyearmonster_submit_bg"), type = ResourcesType.single }
    }
...
function ActionyearmonsterSubmitPanel:open_callback(  )
    ...
    local path = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster","actionyearmonster_submit_bg")
...
function ActionyearmonsterSubmitPanel:crateLabelEffect(num)
    ...
    if #self.label_list > 0 then
        ...
        label = createLabel(50, cc.c4b(0xff,0xcf,0x3c,0xff),cc.c4b(0xb0,0x35,0x0a,0xff),0, 0,"+"..num ,self.progress_container,2, cc.p(0.5,0.5), TITLE_FONT)
    end
    if label then
