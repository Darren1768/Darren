...
function GuildskillResetPanel:open_callback()
    ...
    self.dec_val = createRichLabel(24, cc.c4b(0x68, 0x45, 0x2a, 0xff), cc.p(0, 1), cc.p(50,465),12,nil,580)
