...
function GuildwarController:handle24200( data )
    ...
    EventManager:getInstance():Fire(GuildwarEvent.GuildWarEnemyPositionDataInitEvent)
end
...
function GuildwarController:handle24202( data )
    ...
    if data.code == TRUE then
        self.model:setGuildWarChallengeCount(data.count)
        EventManager:getInstance():Fire(GuildwarEvent.UpdateGuildwarChallengeCountEvent)
...
function GuildwarController:handle24204( data )
    ...
    if data then
        ...
        EventManager:getInstance():Fire(GuildwarEvent.UpdateGuildWarStatusEvent, data.status, data.flag)
    end
end
...
function GuildwarController:handle24207( data )
    if data then
        ...
        EventManager:getInstance():Fire(GuildwarEvent.UpdateGuildWarBaseInfoEvent)
    end
end
...
function GuildwarController:handle24208( data )
    if data then
        ...
        EventManager:getInstance():Fire(GuildwarEvent.GetGuildWarMyPositionDataEvent)
    end
end
...
function GuildwarController:handle24213( data )
    if data then
        EventManager:getInstance():Fire(GuildwarEvent.UpdateGuildWarRankDataEvent, data.ranks)
    end
end
...
function GuildwarController:handle24220( data )
    if data then
        ...
        EventManager:getInstance():Fire(GuildwarEvent.UpdateGuildWarBoxDataEvent, data)
    end
end
...
function GuildwarController:handle24223( data )
    if data then
        ...
        if self.role_vo and data.rid == self.role_vo.rid and data.sid == self.role_vo.srv_id then
            EventManager:getInstance():Fire(GuildwarEvent.UpdateMyAwardBoxEvent)
        end
    end
end
