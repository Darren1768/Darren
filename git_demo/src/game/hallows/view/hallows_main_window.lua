...
function HallowsMainWindow:__init()
	...
	self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_68", true), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("bigbg","pattern/pattern_1"), type = ResourcesType.single},
	}
...
function HallowsMainWindow:open_callback()
	...
	self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg","bigbg_68", true), LOADTEXT_TYPE)
	...
	if self.bottom_bg then
		local res = PathTool.getSingleImgForDownLoad("bigbg","pattern/pattern_1")
		if res ~= nil then
