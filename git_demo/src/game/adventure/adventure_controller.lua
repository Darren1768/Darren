...
function AdventureController:handle20640(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_BASE_INFO_EVENT,data)
end
--单个矿脉信息
...
function AdventureController:handle20641(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_SINGLE_INFO_EVENT,data)
end
...
function AdventureController:handle20643(data)
    message(data.msg)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_FIGHT_EVENT,data)
end
...
function AdventureController:handle20644(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_ALL_LOG_EVENT,data)
end
...
function AdventureController:handle20645(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_SINGE_LOG_EVENT,data)
end
...
function AdventureController:handle20646(data)
    if data.flag == TRUE then
        ...
        EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_SAVE_FORM_EVENT)
...
function AdventureController:handle20647(data)
    ...
    -- EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_BOX_LIST_EVENT,data)
end
...
function AdventureController:handle20648(data)
    ...
    -- EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_RECEIVE_BOX_EVENT,data)
end
...
function AdventureController:handle20651(data)
    if data.code == TRUE then
        ...
        self:send20642()
        EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_GIVE_UP_OCCUPY_EVENT)
    end
    message(data.msg)
end
...
function AdventureController:handle20652(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_MY_MINE_INFO_EVENT, data)
end
...
function AdventureController:handle20653(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_All_LAYER_INFO_EVENT, data)
end
--购买旷工
...
function AdventureController:handle20654(data)
    if data.code == TRUE then
        EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_BUY_EMPLOY_EVENT, data)
    end
    message(data.msg)
end
...
function AdventureController:handle20655(data)
    -- if data.code == TRUE then
    --     EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_BUY_COUNT_EVENT, data)
    -- end
    message(data.msg)
end
--反击
...
function AdventureController:handle20656(data)
    if data.floor ~= 0 and data.room_id ~= 0 then
        EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_STRIKE_BACK_EVENT, data)
        --标志是否有反击操作
...
function AdventureController:handle20657(data)
    ...
    -- EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_RECORD_RED_POINT_EVENT, data)
end
...
function AdventureController:handle20659(data)
    ...
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_LOGIN_RED_POINT_EVENT, data)
end
--获取对手圣器id
...
function AdventureController:handle20658(data)
    EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_HALLOWS_LIST_EVENT, data)
end
--放弃占领
...
function AdventureController:handle20608(data)
    message(data.msg)
    if data.code == 1 then
        EventManager:getInstance():Fire(AdventureEvent.HandleRoomOverEvent, data.room_id)
    end
end
...
function AdventureController:handle20622(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Buff_Info,data)
    end
end

function AdventureController:handle20621(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Guess_Result,data)
    end
end

function AdventureController:handle20623(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Answer_Info, data)
    end
end
...
function AdventureController:handle20630(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Box_Result_Info, data)
    end
end

function AdventureController:handle20627(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Npc_Info, data)
    end
end

function AdventureController:handle20631(data)
    if data.type == 1 then          -- 点击房间事件时候请求20协议之后返回处理
        EventManager:getInstance():Fire(AdventureEvent.Update_Evt_Shop_Info, data)
...
function AdventureController:handle20609(data)
    if data then
        EventManager:getInstance():Fire(AdventureEvent.UpdateSkillInfo, data.skill_list)
    end
end
...
function AdventureController:handle20624(data)
    EventManager:getInstance():Fire(AdventureEvent.UpdateMonsterHP, data.hp_per) 
end
...
function AdventureController:handle20611(data)
    EventManager:getInstance():Fire(AdventureEvent.UpdateShotKillInfo, data.room_list) 
end
...
function AdventureController:handle20632(data)
    EventManager:getInstance():Fire(AdventureEvent.UpdateShopTotalEvent, data.list)
end
...
function AdventureController:handle20633(data)
    message(data.msg)
    if data.code == 1 then
        EventManager:getInstance():Fire(AdventureEvent.UpdateShopItemEvent, data.id)
    end
end
...
function AdventureController:handle20634(data)
    ...
    EventManager:getInstance():Fire(AdventureEvent.UpdateBoxTeskEvent,data)
end
--领取宝箱
...
function AdventureController:handle20625(data)
    EventManager:getInstance():Fire(AdventureEvent.GetSkillForEffectAction, data.id, data.skill_id)
end
...
function AdventureController:handle20612(data)
    ...
    ui_fight_type == MainuiConst.ui_fight_type.adventrueMine then
        ...
        if is_in_fight then --如果是在战斗中,则等战斗结束之后,弹出提示
            EventManager:getInstance():Bind(SceneEvent.EXIT_FIGHT,self, function(combat_type)
