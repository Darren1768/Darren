...
function AdventureMineMyInfoPanel:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_88"), type = ResourcesType.single }
    }
...
function AdventureMineMyInfoPanel:open_callback()
    ...
    loadSpriteTexture(self.bg, PathTool.getSingleImgForDownLoad("bigbg","bigbg_88"), LOADTEXT_TYPE)
