...
function AdventureEvtStartWindow:__init(data)
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_47"), type = ResourcesType.single },
    }
...
function AdventureEvtStartWindow:open_callback()
    ...
    loadSpriteTexture(self.item_icon, PathTool.getSingleImgForDownLoad("bigbg", "bigbg_47"), LOADTEXT_TYPE)
