...
function AdventureMineFightResultPanel:open_callback()
    ...
    self.comfirm_btn = createTypeButton(self.root_wnd,TI18N("占 领"), 620, 500, ButtonType.yellow)
    ...
    self.cancel_btn = createTypeButton(self.root_wnd,TI18N("放弃占领"), 620, 500, ButtonType.red)
