...
function AdventureEvtFighterGuessWindow:__init(data)
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_22"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_21"), type = ResourcesType.single },
    }
end
...
function AdventureEvtFighterGuessWindow:open_callback()
    ...
    loadSpriteTexture(self.bg, PathTool.getSingleImgForDownLoad("bigbg", "bigbg_21"), LOADTEXT_TYPE)
    self.role_bg = self.main_container:getChildByName("role_bg")
    loadSpriteTexture(self.role_bg, PathTool.getSingleImgForDownLoad("bigbg", "bigbg_22"), LOADTEXT_TYPE)
...
function AdventureEvtFighterGuessWindow:register_event()
    ...
    if self.close_btn then
     ...
     EventManager:getInstance():Bind(AdventureEvent.Update_Evt_Guess_Result,self,function (data)
            if data then
