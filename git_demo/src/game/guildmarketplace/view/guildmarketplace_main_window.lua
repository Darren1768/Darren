...
function GuildmarketplaceMainWindow:open_callback(  )
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/guildmarketplace", "guildmarketplace_bg", false)
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/guildmarketplace", "guildmarketplace_record_bg", false)
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/guildmarketplace", "guildmarketplace_chat_bg", false)
...
function GuildmarketplaceMainWindow:register_event(  )
    ...
    self:addGlobalEvent(GuildmarketplaceEvent.GUILD_MARKET_PLACE_MESSAGE_EVENT, function(scdata)
        ...
        EventManager:getInstance():Fire(GuildmarketplaceEvent.GUILD_MARKET_PLACE_MESSAGE_EVENT2, self.message_data)
    end)
