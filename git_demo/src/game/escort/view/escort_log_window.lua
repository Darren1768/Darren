...
function EscortLogWindow:register_event()
	...
	EventManager:getInstance():Bind(EscortEvent.UpdateEscortLogInfoEvent,self, function(data)
	...
	EventManager:getInstance():Bind(EscortEvent.UpdateEscortSingleLogInfo,self, function(data)
