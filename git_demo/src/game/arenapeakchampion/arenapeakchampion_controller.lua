...
function ArenapeakchampionController:handle27700(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_MAIN_EVENT, data)
    ...
    --通知客户端观看录像
    if data.flag == 2 then
        EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_SHOW_VEDIO_EVENT, data)
    end
...
function ArenapeakchampionController:handle27701(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_SINGLE_INFO_EVENT, data)
end
...
function ArenapeakchampionController:handle27702(data)
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_MY_MATCH_INFO_EVENT, data)
end
...
function ArenapeakchampionController:handle27708(data)
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_MY_MATCH_LOG_EVENT, data)
end
...
function ArenapeakchampionController:handle27703(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_GUESSING_INFO_EVENT, data)
end
--竞猜押注
...
function ArenapeakchampionController:handle27704(data)
    ...
    if data.code == TRUE then
        ...
        self:sender27701()
        self.model:setBetTypeInfo(data.bet_type)
        EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_GUESSING_STAKE_EVENT, data)
...
function ArenapeakchampionController:handle27705(data)
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_MY_GUESSING_INFO_EVENT, data)
end
...
function ArenapeakchampionController:handle27707(data)
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_UPDATE_GUESSING_INFO_EVENT, data)
end
...
function ArenapeakchampionController:handle27709(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_TOP_64_EVENT, data)
end
...
function ArenapeakchampionController:handle27710(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_TOP_8_EVENT, data)
end
...
function ArenapeakchampionController:handle27713(data)
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_RANK_EVENT, data)
end
...
function ArenapeakchampionController:handle27714(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_CURRENT_RANK_EVENT, data)
end
...
function ArenapeakchampionController:sender27725(formations)
	...
	for k,v in pairs(formations) do 
		local pos_info = v.pos_info
		for i ,z in pairs(pos_info) do
			table.insert(pos_pid_info,{pid = z.id})
		end 
	end 
	OrganizeController:getInstance():sender29704(95,pos_pid_info)
...
function ArenapeakchampionController:handle27725(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_SAVE_FROM_EVENT, data)
...
function ArenapeakchampionController:handle27726(data)
    ...
    EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_FROM_EVENT, data)
end
...
function ArenapeakchampionController:handle27731(data)
    -- EventManager:getInstance():Fire(ArenapeakchampionEvent.ARENAPEAKCHAMPION_HIT_RED_POINT_EVENT, data)
end
