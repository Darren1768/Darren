...
function ArenapeakchampionGuessingWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/arenapeakchampion", "arenapeakchampion_guessing_bg", true), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_92", false), type = ResourcesType.single},
    }
...
function ArenapeakchampionGuessingWindow:open_callback(  )
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/arenapeakchampion", "arenapeakchampion_guessing_bg", true), LOADTEXT_TYPE)
    ...
    local res  = PathTool.getSingleImgForDownLoad("bigbg/arenapeakchampion","txt_cn_arenapeakchampion_guessing_title", false)
...
function ArenapeakchampionGuessingWindow:openRootWnd(setting)
    ...
    EventManager:getInstance():Fire(BarrageEvent.HandleBarrageType, true, BarrageConst.type.arenapeakchampion)
end
...
function ArenapeakchampionGuessingWindow:close_callback(  )
    ...
    EventManager:getInstance():Fire(BarrageEvent.HandleBarrageType, false, BarrageConst.type.arenapeakchampion)
    controller:openArenapeakchampionGuessingWindow(false)
end