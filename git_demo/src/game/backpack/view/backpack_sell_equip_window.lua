...
function BackPackSellEquipWindow:open_callback()
    ...
    self.Button_1 = self.container:getChildByName("Button_1")

	-- local url="hl_common_4_9.png"
	-- self.cancel_btn:loadTexture(url,1)
	...
	-- self.confirm_btn:loadTexture(url,1)
    ...
    local sell_title=self.container:getChildByName("sell_title")
    sell_title:setFontSize(20)
    sell_title:setTextColor(cc.c3b(98,53,43))

    local txt_title=self.container:getChildByName("img_title_bg_1"):getChildByName("txt_title")
    txt_title:setFontSize(22)
    txt_title:setTextColor(cc.c3b(98,53,43))

    for i=1,5 do
    	local text=self.container:getChildByName('btn_quality_'..i):getChildByName('name')
	    text:setFontSize(20)
	    text:setTextColor(cc.c3b(98,53,43))
    end
    for i=1,6 do
    	local text=self.container:getChildByName('btn_star_'..i):getChildByName('name')
	    text:setFontSize(20)
	    text:setTextColor(cc.c3b(98,53,43))
    end
end
...
function BackPackSellEquipWindow:register_event()
	...
	registerButtonEventListener(self.Button_1, function()
		controller:openQuickSellEquipWindow(false)
	end, true, 2)
