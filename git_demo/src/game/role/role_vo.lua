...
function RoleVo:__init()
    ...
    self.lid                            = 0                     -- 联盟id;
    self.lsrv_id                        = ""                    -- 联盟id;
    self.league_position                       = 0                     -- 联盟职位;
    self.lname                          = ""                    -- 所属联盟的名字
    self.league_lev                         = ""                    -- 联盟等级
    self.league_quit_time                          = ""                    -- 上次退联盟时间
    ...
    self.union_quit_time                = 0                     -- 上次退联盟时间
    ...
    --资产部分
    self.exp                            = 0                     -- 经验;
    self.gold                           = 1000000                     -- 蓝钻 bug 临时赋值 by spp
    self.gold_acc                       = 0                     -- 充值元宝（暂时没有用）
    self.red_gold                       = 0                     -- 红钻
    self.coin                           = 1000000                     -- 金币 bug 临时赋值 by spp
    ...
    self.unicon_coin                    = 0                       -- 联盟贡献积分
    self.league_explore                  = 0                     -- 联盟探险历练积分
...
function RoleVo:setCareer(career)
    self.career = career or 0
end

function RoleVo:getCareer()
    return self.career
end
