...
function RoleHonorUnlockPanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/rolepersonalspace", "txt_cn_role_honor_title", false), type = ResourcesType.single}
    }
...
function RoleHonorUnlockPanel:open_callback(  )
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/rolepersonalspace", "txt_cn_role_honor_title")
