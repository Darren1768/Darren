...
function GuildsecretareaMainWindow:setBackgroundImg(index)
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/guildsecretarea", bg_name, true)
...
function GuildsecretareaMainWindow:onClickRankBtn(  )
    ...
    setting.background_path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_2",true)
