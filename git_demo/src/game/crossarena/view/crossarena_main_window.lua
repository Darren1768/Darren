...
function CrossareanMainWindow:__init()
    ...
    self.background_path = "resource/bigbg/crossarena/hl_bigbg_58.png"
    self.win_type = WinType.Full  
    self.res_list = {
        { path = PathTool.getPlistImgForDownLoad("crossarena","crossarena"), type = ResourcesType.plist },
        { path = PathTool.getSingleImgForDownLoad("bigbg/crossarena","hl_bigbg_58", true), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/crossarena","hl_bigbg_57", true), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/crossarena","hl_crossarena_1007", true), type = ResourcesType.single },
    }
...
function CrossareanMainWindow:open_callback(  )
	...
	self.btn_award:getChildByName("label"):setString(TI18N("排行奖励"))
 ...
 --    local bottom_off = display.getBottom(main_container)
	-- self.close_btn:setPositionY(bottom_off+80)
end
