...
function SubscriptionWechatPanel:loadBackground()
    local bg_path = PathTool.getSingleImgForDownLoad("bigbg/welfare", "txt_cn_subscription_wechat") 
...
function SubscriptionWechatPanel:savePhotoPicture()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/welfare", "txt_cn_subscription_wechat_1")
