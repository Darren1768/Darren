...
function WelfareMainWindow:__init()
    ...
    self.res_list = {
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_bg"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_bg_1"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_tab"), type = ResourcesType.single },
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_fund_bg_1",true), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_fund_bg_2",true), type = ResourcesType.single },
...
function WelfareMainWindow:open_callback()
    ...
    if self.background ~= nil then
        loadSpriteTexture(self.background, PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_bg"), LOADTEXT_TYPE)
    ...
    loadSpriteTexture(self.tab_sprite_bg, PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_bg_1"), LOADTEXT_TYPE)
    ...
    loadSpriteTexture(sprite_tab, PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_tab"), LOADTEXT_TYPE)
