...
function BindPhonePanel:registerEvent()
	...
	EventManager:getInstance():Bind(WelfareEvent.UpdateBindPhoneStatus,self, function() 
			self:updateBindPhoneStatus()
		end)
...
function BindPhonePanel:loadBackground()
	local bg_path = PathTool.getSingleImgForDownLoad("bigbg/welfare", "txt_cn_bind_phone")
