...
function ShopPanel:ctor()
	...
	self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_shop_bg"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_shop_top"), type = ResourcesType.single},
	}
...
function ShopPanel:createRootWnd()
	...
	local bg_path = PathTool.getSingleImgForDownLoad("bigbg/welfare", "welfare_shop_bg")
	...
	local top_path = PathTool.getSingleImgForDownLoad("bigbg/welfare", "welfare_shop_top")
...
function ShopItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("mall/varietystore_item"))
    self:addChild(self.root_wnd)
...
function ShopItem:createItemBgSprite(zorder)
	if not self.item_bg then
		...
		local bg_path = PathTool.getSingleImgForDownLoad("bigbg/welfare", "welfare_shop_grid")
