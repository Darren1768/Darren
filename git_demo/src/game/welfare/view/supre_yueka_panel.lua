...
function SupreYuekaPanel:loadResources()
    self.res_list = {
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","txt_cn_welfare_yueka_bg1"), type = ResourcesType.single },
    } 
...
function SupreYuekaPanel:configUI()
	...
	local res_id = PathTool.getSingleImgForDownLoad("bigbg/welfare", "txt_cn_welfare_yueka_bg1")
