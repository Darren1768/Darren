...
function VersionView:ctor(layout)
    print("===============22222222222222")
    local logo_res = string.format("resource/login/%s/txt_cn_logo.png", PLATFORM_PNG) 
    local bg = createSprite(logo_res, SCREEN_WIDTH*0.5-40, SCREEN_HEIGHT*0.5+80, layout, cc.p(0.5,0.5), LOADTEXT_TYPE)
    bg:setScale(0.8)
    ...
    local logo_res = string.format("resource/login/%s/txt_cn_logo.png", PLATFORM_PNG) 
    local bg = createSprite(logo_res, SCREEN_WIDTH*0.5+20, SCREEN_HEIGHT*0.5, self.root_wnd, cc.p(0.5,0.5), LOADTEXT_TYPE)
    bg:setScale(0.5)
end
