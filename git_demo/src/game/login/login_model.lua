...
function LoginModel:config()
    self.dispatcher = EventManager:getInstance()
...
--            local response =xhr.response
            local servers ={['msg'] = [[info]], ['data'] = {['role_info'] = {}, ['server_list'] = {[1] = {['srv_id'] = [[dev_1]], ['zone_id'] = 1, ['platform'] = [[dev]], ['platform_name'] = [[demo]], ['first_zone'] = 0, ['ip'] = [[s1-symlf-sszg.shiyuegame.com]], ['host'] = [[s1-symlf-sszg.shiyuegame.com]], ['erl_port'] = 9001, ['srv_name'] = [[竖版测试服1]], ['isnew'] = [[1]], ['begin_time'] = 1461923200, ['recomed'] = 1, ['maintain'] = 0, }, }, ['default_zone'] = {['srv_id'] = [[dev_1]], ['zone_id'] = 1, ['platform'] = [[dev]], ['platform_name'] = [[demo]], ['first_zone'] = 0, ['ip'] = [[s1-symlf-sszg.shiyuegame.com]], ['host'] = [[s1-symlf-sszg.shiyuegame.com]], ['erl_port'] = 9001, ['srv_name'] = [[竖版测试服1]], ['isnew'] = [[1]], ['begin_time'] = 1461923200, ['recomed'] = 1, ['maintain'] = 0, }, ['auth'] = [[asdfasfasfasf]], }, }-- loadstring("return " .. response)
--            if servers == nil then
--                servers = {}
--            else
--                servers = servers()
--            end
            self:useLocalServer(servers)
...
function LoginModel:useLocalServer(servers)
    -- PROTO_MATE  = 1   -- 1 测试服 2杨瑞 3 王用勇

    --内部测试  proto_mate  PROTO_MATE  = 1
    servers.data.server_list[1].host = '192.168.0.114'
    servers.data.server_list[1].ip = '192.168.0.114'
    servers.data.server_list[1].erl_port = 9001
  

    
    --杨瑞 proto_mate2   PROTO_MATE =2
    -- servers.data.server_list[1].host = '192.168.0.24'
    -- servers.data.server_list[1].ip = '192.168.0.24'
    -- servers.data.server_list[1].erl_port = 10001

    -- -- 王永勇 proto_mate3 PROTO_MATE =3
    -- servers.data.server_list[1].host = '192.168.0.14'
    -- servers.data.server_list[1].ip = '192.168.0.14'
    -- servers.data.server_list[1].erl_port = 10001


  
    servers.data.default_zone = servers.data.server_list[1]
end
