...
function LimitExerciseController:handle25410(data)
	...
	EventManager:getInstance():Fire(LimitExerciseEvent.LimitExercise_Message_Event,data)
end
--购买挑战次数
...
function LimitExerciseController:handle25411(data)
    ...
    if data.code == 1 then
        ...
        EventManager:getInstance():Fire(LimitExerciseEvent.LimitExercise_BuyCount_Event,data)
    end
end
...
function LimitExerciseController:handle25412(data)
	message(data.msg)
	EventManager:getInstance():Fire(LimitExerciseEvent.LimitExercise_GetBox_Event,data)
end
-- 挑战活动boss
