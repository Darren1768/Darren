...
function MonopolyGuildRankPanel:registerEvent()
     EventManager:getInstance():Bind(MonopolyEvent.Get_Guild_Rank_Data_Event,self, function(data) 
...
function MonopolyGuildRankItem:configUI(  )
	...
	self.rank_index =  createLabel(30,186,nil,50,40,"",self,0, cc.p(0.5,0),TITLE_FONT)
