...
function MonopolyChoseStepWindow:__init()
    ...
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("monopoly","monopoly_big_bg_2"), type = ResourcesType.single},
    }
end
...
function MonopolyChoseStepWindow:onGetDiceResultData(num)
    ...
    EventManager:getInstance():Fire(MonopolyEvent.Get_Role_Move_Event, num)
