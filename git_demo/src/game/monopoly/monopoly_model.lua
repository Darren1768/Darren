...
function MonopolyModel:updateDevelopValById(id, dev_val)
    ...
    EventManager:getInstance():Fire(MonopolyEvent.Update_Dev_Val_Event, id)
end
...
function MonopolyModel:updateGuildDevelopValById(id, dev_val)
    ...
    EventManager:getInstance():Fire(MonopolyEvent.Update_Guild_Dev_Val_Event, id)
end
...
function MonopolyModel:clearMonopolyNowEvtType(id)
    ...
    EventManager:getInstance():Fire(MonopolyEvent.Update_Now_Evt_Type_Event, id)
end
...
function MonopolyModel:updateMonopolyEventType(id, pos, evt_type)
    ...
    EventManager:getInstance():Fire(MonopolyEvent.Update_Grid_Evt_Type_Event, id, pos, evt_type)
end
