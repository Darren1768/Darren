...
function InviteCodeController:handle19800(data)
	...
	EventManager:getInstance():Fire(InviteCodeEvent.Get_InviteCode_Event)
end
--绑定邀请码
...
function InviteCodeController:handle19801(data)
	message(data.msg)
	EventManager:getInstance():Fire(InviteCodeEvent.BindCode_Invite_Event,data)
end
--奖励信息
...
function InviteCodeController:handle19804(data)
	...
	EventManager:getInstance():Fire(InviteCodeEvent.InviteCode_My_Event)
end
...
function InviteCodeController:handle19802(data)
	...
	EventManager:getInstance():Fire(InviteCodeEvent.InviteCode_BindRole_Event)
end
--绑定角色列表（推送）
function InviteCodeController:handle19803(data)
	self.model:setUpdataAlreadyFriendData(data)
	EventManager:getInstance():Fire(InviteCodeEvent.InviteCode_BindRole_Updata_Event)
end
...
function InviteCodeController:handle19811(data)
	...
	EventManager:getInstance():Fire(InviteCodeEvent.Return_InviteCode_Event)
end
--回归奖励领取
