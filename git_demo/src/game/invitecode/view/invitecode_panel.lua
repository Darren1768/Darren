...
function InviteCodePanel:configUI()
    ...
    loadSpriteTexture(bg, PathTool.getSingleImgForDownLoad("bigbg/action","action_invitecode"), LOADTEXT_TYPE)
...
function InviteCodePanel:register_event()
     EventManager:getInstance():Bind(InviteCodeEvent.Get_InviteCode_Event,self,function()
            self:getInviteCodeData()
        end)
     EventManager:getInstance():Bind(InviteCodeEvent.InviteCode_BindRole_Event,self,function()
            self:getAlreadyFriendNum()
        end)
     EventManager:getInstance():Bind(InviteCodeEvent.InviteCode_BindRole_Updata_Event,self,function()
            self:getAlreadyFriendNum()
        end)

    --老友回归红点
     EventManager:getInstance():Bind(InviteCodeEvent.Return_InviteCode_Event,self,function()
    ...
    --邀请红点
     EventManager:getInstance():Bind(InviteCodeEvent.InviteCode_My_Event,self,function()
