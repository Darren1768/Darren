...
function SevenGoalAdventureWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("seven_goals/banner","seven_goals_banner_1"), type = ResourcesType.single},
    }
end
...
function SevenGoalAdventureWindow:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("seven_goals/banner", "seven_goals_banner_1")
