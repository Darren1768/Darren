...
function SevenGoalController:handle13604(data)
    ...
    EventManager:getInstance():Fire(SevenGoalEvent.BaseMessage,data)
end
--刷新任务列表
function SevenGoalController:handle13605(data)
    self.model:setInitDataUpdata(data.list)
    self.model:checkMainRedPoint()
    EventManager:getInstance():Fire(SevenGoalEvent.Tesk_Updata,data)
end
--提交任务
...
function SevenGoalController:handle13609(data)
    EventManager:getInstance():Fire(SevenGoalEvent.Updata_Lev,data)
end
...
function SevenGoalController:handle13607(data)
    ...
    EventManager:getInstance():Fire(SevenGoalEvent.Reward_Lev,data)
end
--领取等级礼包
