...
function ElementMainWindow:__init(  )
	...
	self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/element","element_main_bg", true), type = ResourcesType.single },
		{path = PathTool.getSingleImgForDownLoad("bigbg/element","element_land_1"), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("bigbg/element","element_land_2"), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("bigbg/element","element_land_3"), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("bigbg/element","element_land_4"), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("bigbg/element","element_land_5"), type = ResourcesType.single },
	}
...
function ElementMainWindow:open_callback(  )
	...
	if self.background then
		self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/element","element_main_bg",true), LOADTEXT_TYPE)
	...
	loadSpriteTexture(sp_land_1, PathTool.getSingleImgForDownLoad("bigbg/element","element_land_4"), LOADTEXT_TYPE)
	self.land_list[ElementConst.Ele_Type.Light] = sp_land_1
	local sp_land_2 = self.main_container:getChildByName("sp_land_2")
	loadSpriteTexture(sp_land_2, PathTool.getSingleImgForDownLoad("bigbg/element","element_land_5"), LOADTEXT_TYPE)
	self.land_list[ElementConst.Ele_Type.Dark] = sp_land_2
	local sp_land_3 = self.main_container:getChildByName("sp_land_3")
	loadSpriteTexture(sp_land_3, PathTool.getSingleImgForDownLoad("bigbg/element","element_land_3"), LOADTEXT_TYPE)
	self.land_list[ElementConst.Ele_Type.Wind] = sp_land_3
	local sp_land_4 = self.main_container:getChildByName("sp_land_4")
	loadSpriteTexture(sp_land_4, PathTool.getSingleImgForDownLoad("bigbg/element","element_land_1"), LOADTEXT_TYPE)
	self.land_list[ElementConst.Ele_Type.Water] = sp_land_4
	local sp_land_5 = self.main_container:getChildByName("sp_land_5")
	loadSpriteTexture(sp_land_5, PathTool.getSingleImgForDownLoad("bigbg/element","element_land_2"), LOADTEXT_TYPE)
