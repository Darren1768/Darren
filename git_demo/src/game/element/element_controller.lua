...
function ElementController:handle25000( data )
	if data then
		...
		EventManager:getInstance():Fire(ElementEvent.Update_Element_Data_Event)
...
function ElementController:handle25004( data )
	if data then
		...
		EventManager:getInstance():Fire(ElementEvent.Update_Element_Count_Event)
	end
end
...
function ElementController:handle25005( data )
	if data then
		...
		EventManager:getInstance():Fire(ElementEvent.Update_Element_Customs_Event)
	end
end
