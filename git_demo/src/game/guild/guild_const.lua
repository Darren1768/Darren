...
-- }
 --公会图标类型
GuildConst.icon_type = {
    guild_icon_type_1 = 1,      -- 公会宠物
    guild_icon_type_2 = 2,      -- 公会技能 齐修堂
    guild_icon_type_3 = 3,      -- 公会宝库
    guild_icon_type_4 = 4,       -- 公会副本 公会兑换 
    guild_icon_type_5 = 5,      -- 公会商店 公会赛事
    guild_icon_type_6 = 6,       -- 公会战 公会红包
    guild_icon_type_7 = 7,       -- 公会活跃 限时兑换
    guild_icon_type_8 = 8,       -- 公会捐献 公会使者
    guild_icon_type_9 = 9,      -- 公会红包 公会名册
    guild_icon_type_10 = 10,      --公会排名
    guild_icon_type_11 = 11,      -- 命运树
