...
function GuildNoticeWindow:__init()
    ...
    self.title_sprite = PathTool.getResFrame("guild", "hl_guild_0002")
...
function GuildNoticeWindow:register_event()
     EventManager:getInstance():Bind(GuildEvent.UpdateGuildNoticeList,self, function()
...
function GuildNoticeWindow:updateNoticeList(index)
    ...
    for i,v in ipairs(list) do
        delayRun(self.main_view, 0.02 * i,function ()
            ...
            item:setPosition(cc.p(18, last_height))
...
function GuildNoticeItem:layoutUI()
    ...
    -- self.container:setPosition(cc.p(30,0))
...
function GuildNoticeItem:createOneNotice(time, name, content)
    ...
    local content_label = createRichLabel(22, cc.c3b(129,104,65), cc.p(0, 1), cc.p(15 + time_label:getContentSize().width, size.height), 5, 0, 500)
