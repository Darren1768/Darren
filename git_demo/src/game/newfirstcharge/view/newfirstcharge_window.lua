...
function NewFirstChargeWindow:__init()
	...
	self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_3"), type = ResourcesType.single},
	}
...
function NewFirstChargeWindow:open_callback()
	...
	local res = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_3")
