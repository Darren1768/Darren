...
function RedBagWindow:__init(extend_id)
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_42"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_43"), type = ResourcesType.single },
    }
...
function RedBagWindow:register_event()
    self.background:addTouchEventListener(function(sender, event_type)
     ...
     EventManager:getInstance():Bind(GuildEvent.UpdateGuildRedStatus,self, function(type) 
            local is_red = RedbagController:getInstance():getModel():getIsHaveRedBag()
