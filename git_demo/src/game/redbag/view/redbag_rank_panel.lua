...
function RedBagRankPanel:registerEvents()
    self.look_btn:addTouchEventListener(function(sender, event_type) 
     ...
     EventManager:getInstance():Bind(RedbagEvent.Rank_List_Event,self,function(data)
...
function RedRankItem:layoutUI()
    ...
    self.rank_index =  createLabel(30,Config.ColorData.data_color4[186],nil,50,self.size.height/2,"",self.main_panel,0, cc.p(0.5,0.5),TITLE_FONT)
