...
function AnimateActionFestvalPanel:register_event()
	...
	EventManager:getInstance():Bind(AnimateActionEvent.YuanZhenFestval_Linght,self,function(data)
...
function AnimateActionFestvalPanelItem:configUI()
    ...
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("animateaction/animate_festval_panel_item"))
    self:addChild(self.root_wnd)
