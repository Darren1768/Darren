...
function ActionGiftPanel:configUI(  )
    ...
    local res_id = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_41",true)
    ...
    for i=1,3 do
        ...
        if btn then 
            ...
            local res = PathTool.getSingleImgForDownLoad("actiongift", "actiongift_icon_"..i)
...
function ActionGiftPanel:updateRes()
    ...
    --中央图标
    local res_id = PathTool.getSingleImgForDownLoad("actiongift", "actiongift_show_"..aim)
    ...
    local res_id = PathTool.getSingleImgForDownLoad("actiongift", "txt_cn_actiongift_title_"..aim)
