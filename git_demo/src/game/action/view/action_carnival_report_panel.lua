...
function ActionCarnivalReportPanel:configUI()
	...
	-- 礼包码输入框
	self.key_editbox = createEditBox(self.open_button, PathTool.getResFrame("common", "hl_chat_3"), cc.size(350, 45), cc.c4b(0x7f,0x7f,0x7f,0xff), 24, cc.c4b(0x7f,0x7f,0x7f,0xff), 24, "输入我的礼包码", nil, nil, LOADTEXT_TYPE_PLIST)
