...
function ActionMysteriousStorePanel:register_event()
    EventManager:getInstance():Bind(ActionEvent.UPDATE_STORE_DATA_EVENT,self,function()
    ...
    EventManager:getInstance():Bind(ActionEvent.UPDATE_STORE_DATA_SUCCESS_EVENT,self,function(data)
...
function ActionStoreItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("action/action_mysterious_store_item"))
