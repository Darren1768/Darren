...
function ActionEightLoginWindow:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_eight_bg"), type = ResourcesType.single },
		{ path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_eight_login_title"), type = ResourcesType.single },
    } 
