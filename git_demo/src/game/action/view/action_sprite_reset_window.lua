...
function ActionSpriteResetWindow:loadResources()
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_sprite_return_bg", false), type = ResourcesType.single }
    } 
...
function ActionSpriteResetWindow:configUI()
    ...
    local res  = PathTool.getSingleImgForDownLoad("bigbg/action", "action_sprite_return_bg",false)
...
function ActionSpriteResetWindow:register_event()
    ...
    --精灵重生返回
     EventManager:getInstance():Bind(ActionEvent.SPRITE_RESET_EVENT,self,function (data)
    ...
    --精灵选择返回
     EventManager:getInstance():Bind(ActionEvent.SPRITE_RESET_SELECT_EVENT,self,function (select_sprite_vo)
...
function ActionSpriteResetWindow:updateSprite( sprite_vo )
    if sprite_vo and sprite_vo.config then
        local res = PathTool.getSingleImgForDownLoad("actionspritereset", "sprite_"..sprite_vo.config.icon, false)
