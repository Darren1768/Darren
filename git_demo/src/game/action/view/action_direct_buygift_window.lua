...
function ActionDirectBuygiftWindow:__init( )
    ...
    self.res_list = {
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_57"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg","txt_cn_bigbg_21"), type = ResourcesType.single },
