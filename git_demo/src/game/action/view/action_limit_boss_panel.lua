...
function ActionLimitBossPanel:configUI()
    ...
    self.resources_load = createResourcesLoad(PathTool.getSingleImgForDownLoad("bigbg","bigbg_48", true), ResourcesType.single, function() 
        loadSpriteTexture(self.background, PathTool.getSingleImgForDownLoad("bigbg","bigbg_48", true), LOADTEXT_TYPE)
    end, nil, true)
