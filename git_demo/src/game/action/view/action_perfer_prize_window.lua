...
function ActionPerferPrizeWindow:__init()
    ...
    self.res_list = {
		{path = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "txt_cn_preferprize_1"), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "preferprize_bg_1"), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "preferprize_bg_2"), type = ResourcesType.single},
...
function ActionPerferPrizeWindow:open_callback()
    ...
    if url_png then
        ...
        local res = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "txt_cn_preferprize_1")
	...
	local res = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "preferprize_bg_1")
...
function ActionPerferPeizeItem:configUI()
	self.root_wnd = createCSBNote(PathTool.getTargetCSB("action/action_perfer_prize_item"))
    self:addChild(self.root_wnd)
    self:setContentSize(cc.size(583,148))
    local main_container = self.root_wnd:getChildByName("main_container")
    local image_item = main_container:getChildByName("image_item")
	local res = PathTool.getSingleImgForDownLoad("bigbg/preferprize", "preferprize_bg_2")
