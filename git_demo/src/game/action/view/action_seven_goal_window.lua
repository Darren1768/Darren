...
function ActionSevenGoalWindow:seventGoal(data)
    ...
    if not self.item_load then
        local res1 = PathTool.getSingleImgForDownLoad(str_res,"action_seven_goal_bg1")
    ...
    delayRun(self.layer_tab,2 / display.DEFAULT_FPS,function () 
        if not self.load_round_finish then
            local res2 = PathTool.getSingleImgForDownLoad(str_res,"seven_goals_1_3")
    ...
    delayRun(self.layer_tab,3 / display.DEFAULT_FPS,function () 
        if not self.load_day_title then
            local res3 = PathTool.getSingleImgForDownLoad(str_res,"seven_goals_1_4")
    ...
    for i=1, 7 do
        delayRun(self.layer_tab,i / display.DEFAULT_FPS,function () 
            if i <= self.initCurrentDay then
                if i == day then
                    local res = PathTool.getSingleImgForDownLoad(str_res,"seven_goals_1_2")
                    ...
                    local res = PathTool.getSingleImgForDownLoad(str_res,"seven_goals_1_1")
