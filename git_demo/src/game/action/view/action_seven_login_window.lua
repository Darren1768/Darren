...
function ActionSevenLoginWindow:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_bigbg_2"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_seven_bg1"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_seven_bg2"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_seven_login_title1"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_seven_login_title2"), type = ResourcesType.single },
    } 
...
function ActionSevenLoginWindow:register_event(  )
	...
	--七天登录信息
     EventManager:getInstance():Bind(ActionEvent.UPDATE_SEVEN_LOGIN_STATUS,self,function ( data )
	...
	--领取成功
     EventManager:getInstance():Bind(ActionEvent.UPDATE_SEVEN_LOGIN_REWARDS,self,function ( data )
			-- if data.day < 7 then 
