...
function ActionSkinDirectPurchasePanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/action", "txt_cn_skin_direct_purchase_bg", false), type = ResourcesType.single},
    }
...
function ActionSkinDirectPurchasePanel:open_callback()
    ...
    loadSpriteTexture(self.bg, PathTool.getSingleImgForDownLoad("bigbg/action", "txt_cn_skin_direct_purchase_bg", false), LOADTEXT_TYPE)
