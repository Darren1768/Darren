...
function VoyageModel:config()
	...
	self.order_times = 0  --今日已派遣次数
	self.max_order_times = 0 --今日一共可以派遣次数
end
...
--每日已派遣次数
function VoyageModel:setOrderTimes(times)
	self.order_times = times or 0
end

function VoyageModel:getOrderTimes()
	return self.order_times
end
--每日最大可派遣次数
function VoyageModel:setMaxOrderTimes(times)
	self.max_order_times = times or 0
end

function VoyageModel:getMaxOrderTimes()
	return self.max_order_times
end
