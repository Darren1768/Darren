...
function HeroExpeditController:registerEvents()
     ...
     EventManager:getInstance():Bind(BattleEvent.CLOSE_RESULT_VIEW,self, function(combat_type)
...
function HeroExpeditController:handle24400(data)
    ...
    EventManager:getInstance():Fire(HeroExpeditEvent.HeroExpeditViewEvent, data)
    EventManager:getInstance():Fire(HeroExpeditEvent.Expedit_RedPoint_Event)
...
function HeroExpeditController:handle24401(data)
    ...
    if status == true then
        ...
        if data.id <= grard_id then
            ...
            EventManager:getInstance():Fire(HeroExpeditEvent.levelMessageEvent, data)
        else
...
function HeroExpeditController:handle24402(data)
    ...
    if data.code == 1 then
        ...
        EventManager:getInstance():Fire(HeroExpeditEvent.Get_Box_Event, data.id)
    end
end
...
function HeroExpeditController:hander24405(data)
    EventManager:getInstance():Fire(HeroExpeditEvent.Employ_Me_Help,data)
end
--我的支援选择伙伴，返回24405
...
function HeroExpeditController:hander24406(data)
    ...
    EventManager:getInstance():Fire(HeroExpeditEvent.Employ_Help_Me)
end
--支援我的  选择伙伴  返回24406
...
function HeroExpeditController:hander24411(data)
    ...
    EventManager:getInstance():Fire(HeroExpeditEvent.MeHelp_RedPoint_Event)
end
--选择难度
...
function HeroExpeditController:hander24414(data)
    ...
    EventManager:getInstance():Fire(HeroExpeditEvent.Expedit_Clear_Event,data)
end
--远征录像
...
function HeroExpeditController:hander24415(data)
    EventManager:getInstance():Fire(HeroExpeditEvent.Expedit_Video_Event,data)
end
