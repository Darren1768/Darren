...
function HomeworldController:handle26001( data )
	...
	EventManager:getInstance():Fire(HomeworldEvent.Get_My_Home_Data_Event)
end
...
function HomeworldController:handle26002( data )
	...
	if data.code == 1 then -- 布局成功
		...
		EventManager:getInstance():Fire(HomeworldEvent.Update_Some_Data_Event)
	else  -- 布局失败
		EventManager:getInstance():Fire(HomeworldEvent.Get_My_Home_Data_Event)
	end
end
...
function HomeworldController:handle26005( data )
	...
	if data.code == 1 and data.id then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Update_My_Home_Figure_Event)
	end
end
...
function HomeworldController:handle26006( data )
	...
	if data.code == 1 then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Update_My_Figure_Data_Event, data.id)
	end
end
...
function HomeworldController:handle26009( data )
	if data and data.list then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Get_Random_Visiter_Event, data.list)
	end
end
...
function HomeworldController:handle26010( data )
	if data and data.list then
		EventManager:getInstance():Fire(HomeworldEvent.Get_My_Home_Visiter_Event, data.list)
	end
end
...
function HomeworldController:handle26011( data )
	...
	if data.code == 1 then
		self.model:setMyHomeName(data.name)
		EventManager:getInstance():Fire(HomeworldEvent.Update_My_Home_Name_Event, data.name)
	end
end
...
function HomeworldController:handle26013( data )
	if data and data.list then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Get_Suit_Award_Data_Event)
	end
end
...
function HomeworldController:handle26015( data )
	if data.rest_worship then
		self.model:setLeftWorshipNum(data.rest_worship)
		EventManager:getInstance():Fire(HomeworldEvent.Update_Left_Worship_Num)
	end

	if data.acc_hook_time then
		self.model:setHomeAccHookTime(data.acc_hook_time)
		EventManager:getInstance():Fire(HomeworldEvent.Update_Acc_Hook_Time_Data)
	end
...
function HomeworldController:handle26019( data )
	if data.list then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Get_Today_Worship_Data)
	end
end
...
function HomeworldController:handle26020( data )
	EventManager:getInstance():Fire(HomeworldEvent.Get_Rank_Data_Event, data)
end
...
function HomeworldController:handle26021( data )
	...
	if data.code == TRUE and data.main_floor then
		...
		EventManager:getInstance():Fire(HomeworldEvent.Update_Main_Storey_Event)
	end
end
