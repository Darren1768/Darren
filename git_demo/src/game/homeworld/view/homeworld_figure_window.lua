...
function HomeworldFigureWindow:__init()
	...
	self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("homeworld","homeworld_big_bg_3"), type = ResourcesType.single },
	}
end
...
function HomeworldFigureItem:configUI(  )
    ...
    self.image_bg = createImage(self.root_wnd, PathTool.getResFrame("common","hl_common_91"), self.size.width*0.5, self.size.height*0.5, cc.p(0.5, 0.5), true)
end
