...
function HomeworldUnlockKeyPanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("homeworld","homeworld_unlock_bg"), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("homeworld","homeworld_unlock_key"), type = ResourcesType.single },
    }
