...
function HomePetEventInfoPanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_proto_line"), type = ResourcesType.single}
    }
...
function HomePetEventInfoPanel:open_callback(  )
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_proto_bg", false)
...
function HomePetEventInfoPanel:setInfoEvent()
    local res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_proto_line", false)
    for i=1,3 do
