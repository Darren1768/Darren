...
function GuildvoyageModel:setDailyTimes(times)
    ...
    EventManager:getInstance():Fire(GuildvoyageEvent.UpdateDailyEscortTimes, self.daily_times)
...
function GuildvoyageModel:updateLogInfo(data)
    self.log_info = data
    EventManager:getInstance():Fire(GuildvoyageEvent.UpdateNearLogInfoEvent)
end
--==============================--
--desc:最近订单信息
--@return 
...
function GuildvoyageModel:initGuildVoyageOrderList(data)
    ...
    EventManager:getInstance():Fire(GuildvoyageEvent.UpdateGuildvoyageOrderListEvent)
    ...
    GhostdomController:getInstance():setBuildRedStatus(GhostdomConst.Build_Type.guild, {{bid = GuildConst.red_index.voyage_interaction, status = is_interaction}, {bid = GuildConst.red_index.voyage_escort, status = is_escort}}) 
end
...
function GuildvoyageModel:updateGuildVoyageOrderList(data)
    ...
    if event_type == 1 then
        ...
        EventManager:getInstance():Fire(GuildvoyageEvent.UpdateGuildvoyageOrderStatus, data.order_id, data.status)
    end
    -- 判断有可提交订单红点
...
function GuildvoyageModel:changeGuildVoyageStatus(order_id, status)
    ...
    if vo then
        ...
        EventManager:getInstance():Fire(GuildvoyageEvent.UpdateGuildvoyageOrderStatus, order_id, status)
        -- 判断远航红点状态
...
function GuildvoyageModel:updateGuildVoyageInteractionList(data)
    ...
    EventManager:getInstance():Fire(GuildvoyageEvent.UpdateGuildVoyageInteractionEvent, self.interaction_count, data.assist_list)
...
function GuildvoyageModel:removeGuildVoyageInteraction(data)
    ...
    EventManager:getInstance():Fire(GuildvoyageEvent.RemoveGuildVoyageInteractionEvent, data, self.interaction_count)
