...
function GuildVoyageInteractionPanel:registerEvent()
     EventManager:getInstance():Bind(GuildvoyageEvent.UpdateGuildVoyageInteractionEvent,self, function(interaction_count, list)
			self:showInteractionCount(interaction_count)
			self:createScrollView(list)
		end)

     EventManager:getInstance():Bind(GuildvoyageEvent.RemoveGuildVoyageInteractionEvent,self, function(data, interaction_count)
			self:showInteractionCount(interaction_count)
