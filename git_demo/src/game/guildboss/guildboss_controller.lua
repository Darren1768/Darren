...
function GuildbossController:handle21300(data)
    ...
    EventManager:getInstance():Fire(GuildbossEvent.MusterCoolTime, data.coldtime or 0)
end
...
function GuildbossController:handle21323(data)
    ...
    elseif data.code == 1 then
        ...
        EventManager:getInstance():Fire(GuildbossEvent.MusterCoolTime, less_time or 0)  
    end
end
...
function GuildbossController:handle21318(data)
    EventManager:getInstance():Fire(GuildbossEvent.UpdateGuildDunRank, data, GuildBossConst.rank.guild)
end
...
function GuildbossController:handle21319(data)
    ...
    EventManager:getInstance():Fire(GuildbossEvent.UpdateGuildDunRank, data, GuildBossConst.rank.role)
end
