...
function GuildBossRankRolePanel:ctor(data)
    ...
    self.fight_label = CommonNum.new(220, self.info_container, 99999, - 2, cc.p(0, 0.5))
...
function GuildBossRankRolePanel:registerEvent()
	...
	EventManager:getInstance():Bind(GuildbossEvent.UpdateGuildDunRank,self, function(data, index)
