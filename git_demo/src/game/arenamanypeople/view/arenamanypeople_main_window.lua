...
function ArenaManyPeopleMainWindow:__init()
    ...
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("bigbg/battle_bg/11006", "b_bg", true), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("arenampmatch", "amp_rank_bg_1"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("arenampmatch", "amp_rank_bg_2"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("arenampmatch", "amp_rank_bg_3"), type = ResourcesType.single},
...
function ArenaManyPeopleMainWindow:open_callback(  )
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/battle_bg/11006", "b_bg", true), LOADTEXT_TYPE)
