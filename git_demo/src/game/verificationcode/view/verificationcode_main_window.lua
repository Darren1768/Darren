...
function VerificationcodeMainWindow:open_callback()
    ...
    self.input_edit = createEditBox(self.main_panel, PathTool.getResFrame("common", "hl_chat_3"), size or cc.size(250, 50), Config.ColorData.data_color3[81], 22, nil, 25, placeholder, nil, 10, LOADTEXT_TYPE_PLIST)
