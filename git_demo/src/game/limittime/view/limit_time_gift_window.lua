...
function LimitTimeGiftWindow:__init()
    ...
    self.res_list = {
    	...
    	{ path = PathTool.getSingleImgForDownLoad("bigbg/festivalaction","personalgift_bg1"), type = ResourcesType.single},
	}
    self.item_list = {}
    self.cur_index = nil
...
function LimitTimeGiftWindow:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/festivalaction","personalgift_bg1")
