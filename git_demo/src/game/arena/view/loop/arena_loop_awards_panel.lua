...
--
-- --------------------------------------------------------------------
-- ArenaLoopAwardsPanel = ArenaLoopAwardsPanel or BaseClass(BaseView)
...
-- function ArenaLoopAwardsPanel:__init()
--     self.view_tag = ViewMgrTag.DIALOGUE_TAG
-- 	self.win_type = WinType.Big
	
-- 	self.layout_name = "arena/new_arena_loop_awards_panel"
-- 	self.res_list = {
...
function ArenaLoopAwardsPanel:ctor()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("arena/new_arena_loop_awards_panel"))
...
function ArenaLoopAwardsPanel:registerEvent()
    self.background:addTouchEventListener(function(sender, event_type)
		if event_type == ccui.TouchEventType.ended then
			playQuitSound()
			-- controller:openArenaLoopAwardWindow(false)
...
-- ============================================ layer时候调用====================
function ArenaLoopAwardsPanel:open_callback()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("arena/new_arena_loop_awards_panel"))
    self.main_container = self.root_wnd:getChildByName("main_container")
...
function ArenaLoopAwardsPanel:register_event()
    self.background:addTouchEventListener(function(sender, event_type)
		if event_type == ccui.TouchEventType.ended then
			playQuitSound()
			controller:openArenaLoopAwardWindow(false)
...
function ArenaLoopAwardsPanel:openRootWnd()
    self:handleEvent(true)
    self:addToParent()
    self:updatePanelInfo(false)
end

function ArenaLoopAwardsPanel:close_callback()
    self:handleEvent(false)
    for i, v in ipairs(self.item_list) do
		v:DeleteMe()
	end
