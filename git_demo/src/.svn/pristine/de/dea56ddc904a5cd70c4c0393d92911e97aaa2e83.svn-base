...
function BuyLevWindow:open_callback()
    ...
    --购买等级
    self.buy_editbox = createEditBox(main_container, PathTool.getResFrame("common", "hl_chat_3"), cc.size(200, 50), cc.c4b(0x95,0x95,0x95,0xff), 26, cc.c4b(0x95,0x95,0x95,0xff), 26, "1", nil, 6, LOADTEXT_TYPE_PLIST)
