...
function GuildsecretareaController:handle26800(data)
    ...
    EventManager:getInstance():Fire(GuildsecretareaEvent.GUILD_SECRET_AREA_MAIN_EVENT, data)
end
...
function GuildsecretareaController:handle26801(data)
    ...
    if data.flag == TRUE then
        -- EventManager:getInstance():Fire(GuildsecretareaEvent.TERM_BEGINS_BUY_COUNT_EVENT, data)
    end
end
...
function GuildsecretareaController:handle26803(data)
    ...
    if data.flag == TRUE then
        ...
        EventManager:getInstance():Fire(GuildsecretareaEvent.GUILD_SECRET_AREA_BUY_COUNT_EVENT, data)
    end
end
...
function GuildsecretareaController:handle26804(data)
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(GuildsecretareaEvent.TERM_BEGINS_RECEIVE_REWARD_EVENT, data)
    end
end
...
function GuildsecretareaController:handle26805(data)
    ...
    if data.flag == TRUE then
        self:sender26800()
        EventManager:getInstance():Fire(GuildsecretareaEvent.GUILD_SECRET_AREA_REFRESH_RANK_EVENT)
    end
end
...
function GuildsecretareaController:handle26806(data)
    ...
    EventManager:getInstance():Fire(GuildsecretareaEvent.GUILD_SECRET_AREA_RANK_COUNT_EVENT, data)
end
--讨伐开始弹窗
