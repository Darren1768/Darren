...
-- --------------------------------------------------------------------
SpiritGetWindow = SpiritGetWindow or BaseClass(BaseView)

function SpiritGetWindow:__init(tower)
    self.ctrl = SpiritController:getInstance()
    
    self.layout_name = "spirit/spirit_get"
    self.res_list = {
...
function SpiritGetWindow:open_callback()
...
function SpiritGetWindow:register_event()
...
function SpiritGetWindow:createDesc()
...
function SpiritGetWindow:updateDesc()
...
function SpiritGetWindow:openRootWnd()
...
function SpiritGetWindow:setPanelData()
end

function SpiritGetWindow:handleEffect(status)
...
function SpiritGetWindow:close_callback()
    self.ctrl:openGetWindow(false)
