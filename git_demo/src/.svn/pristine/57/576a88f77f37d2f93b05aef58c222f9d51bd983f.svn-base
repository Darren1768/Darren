...
function ActionLimitGroupbuyPanel:loadResources()
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/action","action_acc_limit"), type = ResourcesType.single },
    } 
...
function ActionLimitGroupbuyPanel:configUI()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/action", "action_acc_limit")
