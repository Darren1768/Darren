...
function PetardActionController:registerEvents()
     ...
     EventManager:getInstance():Bind(Battle_dramaEvent.Close_Hook_Alert_Event,self, function()
...
function PetardActionController:handle27000( data )
	...
	EventManager:getInstance():Fire(PetardActionEvent.Get_Base_Info_Event)
end
...
function PetardActionController:handle27002( data )
	...
	EventManager:getInstance():Fire(PetardActionEvent.Get_Redbag_Data_Event)
end
...
function PetardActionController:handle27004( data )
	if data.code then
		EventManager:getInstance():Fire(PetardActionEvent.Update_Petard_Main_Redbag_Event, data.code)
	end
end
...
function PetardActionController:handle27006( data )
	if data.get_red_packet_list then
		EventManager:getInstance():Fire(PetardActionEvent.Get_Redbag_Msg_Data_Event, data.get_red_packet_list)
	end
end
