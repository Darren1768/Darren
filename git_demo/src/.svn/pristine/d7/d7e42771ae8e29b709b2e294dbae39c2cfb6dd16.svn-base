...
function VarietyStoreWindows:__init()
	...
	self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_72", true), type = ResourcesType.single },
        {path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_73"), type = ResourcesType.single },
		{path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_74"), type = ResourcesType.single },
		{path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_75"), type = ResourcesType.single },
		{path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_76"), type = ResourcesType.single },
	}
end
...
function VarietyStoreWindows:open_callback()
    ...
    if self.background ~= nil then
    	self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg","bigbg_72",true), LOADTEXT_TYPE)
