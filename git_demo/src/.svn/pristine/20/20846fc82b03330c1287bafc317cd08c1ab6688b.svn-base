...
function ElitematchOrderactionUntieRewardWindow:__init()
    ...
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("bigbg/elitematch","elitematch_orderaction_bg"), type = ResourcesType.single},
    }
end
...
function ElitematchOrderactionUntieRewardWindow:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/elitematch", "elitematch_orderaction_bg")
