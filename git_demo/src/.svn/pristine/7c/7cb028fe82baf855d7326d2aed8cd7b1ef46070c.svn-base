...
function HomePetGooutProgressPanel:__init(show_type)
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_travelling_bg"), type = ResourcesType.single}
    }
...
function HomePetGooutProgressPanel:runPetTimer()
    local res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_travelling_bg", false)
    self.run_img = {}
...
function HomePetGooutProgressPanel:runPetAction()
    -- local res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_mask", false)
