...
function ActionFundOnePanel:configUI(  )
    ...
    image_bg:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_fund_bg_1",true), LOADTEXT_TYPE)
...
function ActionFundOnePanel:register_event(  )
	...
	registerButtonEventListener(self.btn_award, handler(self, self._onClickAwardBtn), true)
     ...
     EventManager:getInstance():Bind(ActionEvent.UPDATA_FUND_DATA_EVENT,self,function (id)
