...
function HeroResetWindow:loadResResources(index)
    ...
    --     self.res_list = {
    --         { path = PathTool.getSingleImgForDownLoad("bigbg/hero",HeroConst.CampBgRes[HeroConst.CampType.eWater], true), type = ResourcesType.single },
    --         { path = PathTool.getSingleImgForDownLoad("bigbg/hero",HeroConst.CampBottomBgRes[HeroConst.CampType.eWater], false), type = ResourcesType.single },
    ...
    --         { path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_hero_convert_stage",false), type = ResourcesType.single },
    --     }
...
-----------------@ 按钮点击事件
-- 关闭
function HeroResetWindow:_onClickCloseBtn(  )
