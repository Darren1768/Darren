...
function PractiseTowerResultWindow:open_callback()
	...
	if self.result == 0 then
		playOtherSound("b_lose", GlobalAudio.AUDIO_TYPE.BATTLE) 
	else
	...
	self.comfirm_btn = createTypeButton(self.root_wnd,TI18N("确定"), 620, 580, ButtonType.yellow)
	...
	self.cancel_btn = createTypeButton(self.root_wnd,TI18N("重新挑战"), 620, 580, ButtonType.red)
