...
function TreasureOpenAwardWindow:__init()
    ...
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("bigbg/festivalaction","txt_cn_festival_treasure_open"), type = ResourcesType.single},
    }
end
...
function TreasureOpenAwardWindow:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/festivalaction","txt_cn_festival_treasure_open")
