...
function ChargeDiamondPanel:registerEvent( )
    ...
    if self.role_vo then
     ...
     EventManager:getInstance():Bind(VipEvent.UPDATE_CHARGE_LIST,self,function(list )
     ...
     EventManager:getInstance():Bind(VipEvent.Update_Gift_Red_state,self,function( )
			self:updateVipRedStatus()
		end)
end
