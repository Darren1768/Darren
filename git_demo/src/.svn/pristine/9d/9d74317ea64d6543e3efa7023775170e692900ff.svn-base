...
function ArenaChampionBestInfoWindow:__init(view_type)
	...
	self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_46"), type = ResourcesType.single}
	}
...
function ArenaChampionBestInfoWindow:open_callback()
    ...
    if self.view_type == ArenaConst.champion_type.normal then
        image_1:loadTexture(PathTool.getSingleImgForDownLoad("bigbg", "bigbg_46") ,LOADTEXT_TYPE)
        image_2:loadTexture(PathTool.getSingleImgForDownLoad("bigbg", "bigbg_46") ,LOADTEXT_TYPE)
