...
function StoryMangaView:__init()
	...
	self.res_list = {
		{path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_44", true), type = ResourcesType.single},
	}
end
...
function StoryMangaView:openRootWnd(effect_id, action_num)
    ...
    -- GlobalAudio:getInstance():playMusic(GlobalAudio.AUDIO_TYPE.BATTLE, "b_003", true) 
end
