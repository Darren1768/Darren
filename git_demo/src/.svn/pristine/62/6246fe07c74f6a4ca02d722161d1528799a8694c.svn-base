...
function ActionyearmonsterChallengePanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster","actionyearmonster_challenge_bg"), type = ResourcesType.single }
    }
...
function ActionyearmonsterChallengePanel:open_callback(  )
    ...
    local path = PathTool.getSingleImgForDownLoad("bigbg/actionyearmonster","actionyearmonster_challenge_bg")
