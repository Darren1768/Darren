...
function EndlessHelpMePanel:registerEvent()
    EventManager:getInstance():Bind(Endless_trailEvent.UPDATA_HIREPARNER_DATA,self,function(data)
            self:updateListData(data)
        end)
    
    EventManager:getInstance():Bind(Endless_trailEvent.UPDATA_HASHIREPARNER_DATA,self,function(data)
