...
Config.MarketGoldData.data_market_gold_cost_fun = function(key)
	local data=Config.MarketGoldData.data_market_gold_cost[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_market_gold_cost['..key..'])not found') return
	end
	return data
end
...
Config.MarketGoldData.data_skill_shop_list_fun = function(key)
	local data=Config.MarketGoldData.data_skill_shop_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_skill_shop_list['..key..'])not found') return
	end
	return data
end
-- -------------------skill_shop_list_end---------------------
...
Config.MarketGoldData.data_form_shop_list_fun = function(key)
	local data=Config.MarketGoldData.data_form_shop_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_form_shop_list['..key..'])not found') return
	end
	return data
end
-- -------------------form_shop_list_end---------------------
...
Config.MarketGoldData.data_break_shop_list_fun = function(key)
	local data=Config.MarketGoldData.data_break_shop_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_break_shop_list['..key..'])not found') return
	end
	return data
end
-- -------------------break_shop_list_end---------------------
...
Config.MarketGoldData.data_other_shop_list_fun = function(key)
	local data=Config.MarketGoldData.data_other_shop_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_other_shop_list['..key..'])not found') return
	end
	return data
end
-- -------------------other_shop_list_end---------------------
...
Config.MarketGoldData.data_hide_sell_list_fun = function(key)
	local data=Config.MarketGoldData.data_hide_sell_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_hide_sell_list['..key..'])not found') return
	end
	return data
end
-- -------------------hide_sell_list_end---------------------
...
Config.MarketGoldData.data_stable_sell_list_fun = function(key)
	local data=Config.MarketGoldData.data_stable_sell_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_stable_sell_list['..key..'])not found') return
	end
	return data
end
...
Config.MarketGoldData.data_change_sell_list_fun = function(key)
	local data=Config.MarketGoldData.data_change_sell_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_change_sell_list['..key..'])not found') return
	end
	return data
end
...
Config.MarketGoldData.data_explain_fun = function(key)
	local data=Config.MarketGoldData.data_explain[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketGoldData.data_explain['..key..'])not found') return
	end
	return data
end
-- -------------------explain_end---------------------
