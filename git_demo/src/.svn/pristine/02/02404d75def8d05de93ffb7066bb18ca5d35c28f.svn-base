...
function NewFirstChargeWindow3:__init()
	...
	self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_4"), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_6"), type = ResourcesType.single},
	}
...
function NewFirstChargeWindow3:open_callback()
	...
	local res = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_4")
...
function NewFirstChargeWindow3:changeTabView(index)
	...
	elseif index == 2 then
		local res = PathTool.getSingleImgForDownLoad("bigbg/action","txt_cn_action_bigbg_6")
