...
function GuildbossModel:updateGuildDunBaseInfo(data)
    ...
    EventManager:getInstance():Fire(GuildbossEvent.UpdateGuildDunBaseInfo)
    --判断一下当前的Boss是否能打
    -- 更新红点
...
function GuildbossModel:updateBaseWithTimes(count, buy_count, buy_type)
    ...
    EventManager:getInstance():Fire(GuildbossEvent.UpdateGuildBossChallengeTimes, buy_type) 
    -- 更新红点
...
function GuildbossModel:initFirstPassRewardList(data)    
    ...
    --     end
    -- end
    -- EventManager:getInstance():Fire(GuildbossEvent.UpdateFirstPassReward)
end
...
function GuildbossModel:initDayBoxRewardsStatus(data_list)
    ...
    EventManager:getInstance():Fire(GuildbossEvent.UpdateBoxRewardsStatus)
end
...
function GuildbossModel:updateBoxRewards(fid, num)
    ...
    -- EventManager:getInstance():Fire(GuildbossEvent.UpdateBoxRewardsStatus, true) 
end
