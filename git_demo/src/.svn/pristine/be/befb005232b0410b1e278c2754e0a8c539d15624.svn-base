...
function GuildskillController:handle23704(data)
    EventManager:getInstance():Fire(GuildskillEvent.UpdateSkillResetEvent, data)
end
--请求重置
...
function GuildskillController:handle23706(data)
    ...
    if data.flag == TRUE then
        EventManager:getInstance():Fire(GuildskillEvent.Guild_Pvp_Career_Break_Event, data.career)
    end
end
...
function GuildskillController:handle23707(data)
    message(data.msg)
    if data.flag == TRUE then
        EventManager:getInstance():Fire(GuildskillEvent.Guild_Pvp_Career_Update_Event, data.career, 2, self.record_id)
    end
end
...
function GuildskillController:handle23708(data)
    ...
    if data.flag == TRUE then
        ...
        EventManager:getInstance():Fire(GuildskillEvent.Guild_Pvp_Career_Update_Event, data.career, 1)
    end
end
...
function GuildskillController:handle23710(data)
    ...
    EventManager:getInstance():Fire(GuildskillEvent.Guild_Pvp_Career_Info_Event, data.career)
end
...
function GuildskillController:handle23711(data)
    ...
    self.model:setPvpFisrtReset(data.is_first == 1)
    EventManager:getInstance():Fire(GuildskillEvent.Guild_Pvp_Skill_Info_Event, data)
end
