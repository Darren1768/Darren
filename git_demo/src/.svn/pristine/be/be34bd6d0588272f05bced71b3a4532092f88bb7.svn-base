...
function SevenGoalSecretWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("seven_goals/banner","seven_goals_banner_3"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("seven_goals/banner","seven_goals_banner_4"), type = ResourcesType.single},
    }
    self.tesk_list = {}
...
function SevenGoalSecretWindow:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("seven_goals/banner", "seven_goals_banner_4")
    ...
    local res_1 = PathTool.getSingleImgForDownLoad("seven_goals/banner", "seven_goals_banner_3")
