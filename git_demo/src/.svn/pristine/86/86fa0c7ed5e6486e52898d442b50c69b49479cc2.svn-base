...
function GuildmarketplaceController:handle26900(data)
    EventManager:getInstance():Fire(GuildmarketplaceEvent.GUILD_MARKET_PLACE_ITEM_EVENT, data)
end
...
function GuildmarketplaceController:handle26901(data)
    message(data.msg)
    -- EventManager:getInstance():Fire(GuildmarketplaceEvent.GUILD_MARKET_PLACE_PUT_ITEM_EVENT, data)
end
...
function GuildmarketplaceController:handle26902(data)
    message(data.msg)
    -- EventManager:getInstance():Fire(GuildmarketplaceEvent.GUILD_MARKET_PLACE_BUY_ITEM_EVENT, data)
end
...
function GuildmarketplaceController:handle26903(data)
    EventManager:getInstance():Fire(GuildmarketplaceEvent.GUILD_MARKET_PLACE_MESSAGE_EVENT, data)
end
