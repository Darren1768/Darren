...
function GoodsBaseTips:createBackground()
	--背景界面
	self.background = createScale9Sprite(PathTool.getResFrame("common", "hl_common_47"), 0, 0)
    ...
    local line = createScale9Sprite(PathTool.getResFrame("common", "hl_common_46"), 0, 0)
	line:setContentSize(cc.size(326, 9))
	line:setAnchorPoint(cc.p(0.5, 0.5))
	self.main_container:addChild(line)
    line:setPosition(cc.p(self.WIDTH/2,240))
end
