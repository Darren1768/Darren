...
TITLE_FONT                = "fonts/title.ttf"      -- 标题字体
...
USE_PVR_CCZ             = false             -- 是否使用pvr.ccz合图
USE_RES_LUA             = false             -- 是否使用lua ui文件
...
-- 配置信息获取地址
URL_LUA_CONFIG="http://119.29.165.48/update/config/url_config_demo.lua" 
...
-- 日志上报地址
LOG_URL = "http://119.29.165.48/index.php"
