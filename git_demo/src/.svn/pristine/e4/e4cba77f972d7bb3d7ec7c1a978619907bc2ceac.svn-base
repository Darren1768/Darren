...
function TrainingcampMainWindow:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_90"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_91"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_92"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_95", true), type = ResourcesType.single },
	}
end

function TrainingcampMainWindow:open_callback()
    self.background = self.root_wnd:getChildByName("background")
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg","bigbg_95",true), LOADTEXT_TYPE)
