...
function GuildActionGoalWindow:register_event()
     EventManager:getInstance():Bind(GuildEvent.UpdataGuildGoalBasicData,self,function ( data )
     ...
     EventManager:getInstance():Bind(GuildEvent.UpdataGuildGoalTaskData,self,function ( data )
            self.receve_list = {}
            local data_sort = {}
     ...
     EventManager:getInstance():Bind(GuildEvent.UpdataGuildGoalSingleTaskData,self,function ( data )
