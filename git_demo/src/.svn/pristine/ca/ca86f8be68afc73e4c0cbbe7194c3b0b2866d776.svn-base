...
function ActionSpecialVipWindow:__init()
    ...
    self.res_list = {
		{path = PathTool.getSingleImgForDownLoad("bigbg/specialvip", "txt_cn_specialvip_1_bg"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("bigbg/specialvip", "txt_cn_specialvip_2_bg"), type = ResourcesType.single},
		{path = PathTool.getSingleImgForDownLoad("bigbg/specialvip", "txt_cn_specialvip_2"), type = ResourcesType.single},
	}
end
function ActionSpecialVipWindow:open_callback()
	...
	local res = PathTool.getSingleImgForDownLoad("bigbg/specialvip", res_bg)
    ...
    local res_1 = PathTool.getSingleImgForDownLoad("bigbg/specialvip", goto_res)
