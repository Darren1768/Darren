...
Config.ZsWarData.data_const_fun = function(key)
	local data=Config.ZsWarData.data_const[key]
	if DATA_DEBUG and data == nil then
		print('(Config.ZsWarData.data_const['..key..'])not found') return
	end
	return data
end
-- -------------------const_end---------------------
...
Config.ZsWarData.data_explain_fun = function(key)
	local data=Config.ZsWarData.data_explain[key]
	if DATA_DEBUG and data == nil then
		print('(Config.ZsWarData.data_explain['..key..'])not found') return
	end
	return data
end
-- -------------------explain_end---------------------
...
Config.ZsWarData.data_skill_fun = function(key)
	local data=Config.ZsWarData.data_skill[key]
	if DATA_DEBUG and data == nil then
		print('(Config.ZsWarData.data_skill['..key..'])not found') return
	end
	return data
end
-- -------------------skill_end---------------------
...
Config.ZsWarData.data_group_fun = function(key)
	local data=Config.ZsWarData.data_group[key]
	if DATA_DEBUG and data == nil then
		print('(Config.ZsWarData.data_group['..key..'])not found') return
	end
	return data
end
-- -------------------group_end---------------------
