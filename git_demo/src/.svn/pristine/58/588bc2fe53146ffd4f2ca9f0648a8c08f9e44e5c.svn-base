...
function ChargeClothPanel:registerEvent( )
     EventManager:getInstance():Bind(MallEvent.Get_Chose_Shop_Data_Event,self,function(data)
...
function ChargeClothItem:configUI(  )
 ...
 --    self.name_txt = createLabel(30, cc.c4b(255,244,196,255), cc.c4b(65,29,4,255), name_pos_x, name_pos_y, "", self.container, 2, cc.p(0.5, 0.5), TITLE_FONT )
