...
function HallowsMagicWindow:__init()
	...
	self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg","bigbg_81"), type = ResourcesType.single },
	}
...
function HallowsMagicWindow:open_callback(  )
	...
	top_bg:loadTexture(PathTool.getSingleImgForDownLoad("bigbg","bigbg_81"), LOADTEXT_TYPE)
