...
ExplorationTrialMainWindow = ExplorationTrialMainWindow or BaseClass(BaseView)

function ExplorationTrialMainWindow:__init()
    
    self.win_type = WinType.Full
    self.layout_name = "exploration_trial/exploration_trial_main_window"
...
function ExplorationTrialMainWindow:open_callback( )
...
-- 更新位置
function ExplorationTrialMainWindow:updateMainScene(x, y)
    y = y or self.init_y
    for i=1, self.layer_num do
...
function ExplorationTrialMainWindow:register_event()
...
function ExplorationTrialMainWindow:openRootWnd()
...
-- 移动场景
function ExplorationTrialMainWindow:moveMainScene(x)
...
-- 位置校准
function ExplorationTrialMainWindow:scaleCheckPoint( _x )
    if _x > 0 then
        _x = 0
...
function ExplorationTrialMainWindow:setVisible(bool)
...
-- 创建建筑
function ExplorationTrialMainWindow:createBtnList()
...
-- 更新或创建地图和建筑
function ExplorationTrialMainWindow:setMapAndBuild()
...
-- 初始化地图数据
function ExplorationTrialMainWindow:initMapCacheData()
    self.map_data = {}
...
-- 创建地图
function ExplorationTrialMainWindow:createMap()
...
function ExplorationTrialMainWindow:onClickCloseBtn()
...
function ExplorationTrialMainWindow:setBuildRedStatus( bid )
...
function ExplorationTrialMainWindow:close_callback()
