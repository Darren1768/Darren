...
Config.StarDivinationData.data_divination_const_fun = function(key)
	local data=Config.StarDivinationData.data_divination_const[key]
	if DATA_DEBUG and data == nil then
		print('(Config.StarDivinationData.data_divination_const['..key..'])not found') return
	end
	return data
end
...
Config.StarDivinationData.data_divination_flash_name_fun = function(key)
	local data=Config.StarDivinationData.data_divination_flash_name[key]
	if DATA_DEBUG and data == nil then
		print('(Config.StarDivinationData.data_divination_flash_name['..key..'])not found') return
	end
	return data
end
...
Config.StarDivinationData.data_divination_flash_fun = function(key)
	local data=Config.StarDivinationData.data_divination_flash[key]
	if DATA_DEBUG and data == nil then
		print('(Config.StarDivinationData.data_divination_flash['..key..'])not found') return
	end
	return data
end
...
Config.StarDivinationData.data_explain_fun = function(key)
	local data=Config.StarDivinationData.data_explain[key]
	if DATA_DEBUG and data == nil then
		print('(Config.StarDivinationData.data_explain['..key..'])not found') return
	end
	return data
end
-- -------------------explain_end---------------------
