...
function MallBuyWindow:open_callback(  )
    ...
    self.ok_label = self.ok_btn:getChildByName("text_ok")
	self.ok_label:setString(TI18N("购买"))

	local url="hl_common_4_10.png"
	self.ok_btn:loadTextures(url,url,url,1)
	...
	self.cancel_btn:loadTextures(url,url,url,1)
