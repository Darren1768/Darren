...
function ActionyearmonsterModel:updateYearEvtVoList( data_list )
    ...
    if next(add_evt_vo_list) ~= nil then
        EventManager:getInstance():Fire(ActionyearmonsterEvent.YEAR_Add_Evt_Data_Event, add_evt_vo_list)
    end
end
...
function ActionyearmonsterModel:setYearBagData( secret_item )
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Iint_Bag_Data_Event)
end
...
function ActionyearmonsterModel:updateYearBagData( data_list )
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Update_Bag_Data_Event, data_list, is_add)
end
...
function ActionyearmonsterModel:deleteYearBagData( data_list )
    ...
    EventManager:getInstance():Fire(ActionyearmonsterEvent.Year_Delete_Bag_Data_Event, data_list)
end
