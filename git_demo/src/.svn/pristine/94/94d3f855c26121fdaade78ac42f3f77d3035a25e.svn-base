...
function AdventureEvtNpcView:__init(data)
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_18"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_45"), type = ResourcesType.single },
    }
...
function AdventureEvtNpcView:open_callback()
    ...
    loadSpriteTexture(self.role_bg,PathTool.getSingleImgForDownLoad("bigbg", "bigbg_45"), LOADTEXT_TYPE)
    self.bg:loadTexture(PathTool.getSingleImgForDownLoad("bigbg", "bigbg_18"), LOADTEXT_TYPE)
...
function AdventureEvtNpcView:register_event()
    if self.close_btn then
     ...
     EventManager:getInstance():Bind(AdventureEvent.Update_Evt_Npc_Info,self,function (data)
