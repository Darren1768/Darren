...
function ActionHighValueGiftPanel:configUI()
    ...
    self.jump_btn = createImage(self.main_container, PathTool.getSingleImgForDownLoad("bigbg/action", jump_str), 600, 770, cc.p(0.5,0.5), false, 1, true)
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/action", str)
...
function ActionHighValueGiftPanel:register_event()
    ...
    registerButtonEventListener(self.jump_btn, function()
     ...
     EventManager:getInstance():Bind(ActionEvent.Is_Charge_Event,self,function(data)
