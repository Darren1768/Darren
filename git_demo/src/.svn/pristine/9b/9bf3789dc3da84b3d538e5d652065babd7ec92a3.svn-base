...
function WeiXinGiftPanel:loadResources()
    self.res_list = {
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_weixin"), type = ResourcesType.single },
        { path = PathTool.getSingleImgForDownLoad("bigbg/welfare","txt_cn_welfare_weixin_title"), type = ResourcesType.single },
    } 
...
function WeiXinGiftPanel:loadResListCompleted()
    loadSpriteTexture(self.bg, PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_weixin"), LOADTEXT_TYPE)
    loadSpriteTexture(self.title, PathTool.getSingleImgForDownLoad("bigbg/welfare","txt_cn_welfare_weixin_title"), LOADTEXT_TYPE)
    self:createList()
end
