...
function TipsSource:open_callback()
    ...
    self.goods_item:setPosition(110,320)
	self.goods_item:setScale(0.9)
    self.main_container:addChild(self.goods_item)

    self.desc_scroll = createScrollView(300,50,177,270,self.main_container,ccui.ScrollViewDir.vertical)

    self.desc = createRichLabel(20, cc.c3b(98,53,43), cc.p(0,1), cc.p(0,self.desc_scroll:getContentSize().height), 0, 0, 400)
