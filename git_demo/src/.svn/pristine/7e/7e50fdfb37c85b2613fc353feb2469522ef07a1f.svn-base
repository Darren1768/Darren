...
function ReturnActionShopPanel:register_event()
     EventManager:getInstance():Bind(ReturnActionEvent.Shop_Event,self,function(data)
...
function ReturnActionShopItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("returnaction/returnaction_shop_item"))
