                            ...
                            local res                                                          = PathTool.getSingleImgForDownLoad("bigbg/hero", "hero_return_bg",true)
                            ...
                            --英雄重生返回
                            EventManager:getInstance():Bind(HeroEvent.HERO_RESET_EVENT,self,function (data)
                            ...
                            --选择英雄返回
                            EventManager:getInstance():Bind(HeroEvent.HERO_RETURN_SELECT_EVENT,self,function (select_hero_vo)
                            ...
                            --获取升星材料返回
                            EventManager:getInstance():Bind(HeroEvent.HERO_RESET_ITEM_EVENT,self, function(data)
                            if not data then return end
