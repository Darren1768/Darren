...
function RoleChangeView:createInputContainer(placeholder,max_len, desc, off_y, touch_enabled)
    if self.input_edit == nil then
        self.input_edit = createEditBox(self.main_container, PathTool.getResFrame("common", "hl_chat_3"), cc.size(250, 50), Config.ColorData.data_color3[151], 24, Config.ColorData.data_color3[151], 24, placeholder, nil, max_len, LOADTEXT_TYPE_PLIST)
    end
