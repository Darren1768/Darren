...
function AdventureUIModel:setChallengeCount( count )
    if count then
        ...
        if old_count and old_count ~= self.challenge_count then
            --有变化
            self:checkRedPoint()
            EventManager:getInstance():Fire(AdventureEvent.ADVENTURE_MINE_CHALLEAGE_RED_POINT_EVENT)
        end
    end
end
...
function AdventureUIModel:updateFormPartner(data, partner_id)
    ...
    EventManager:getInstance():Fire(AdventureEvent.UpdateAdventureForm)
end
...
function AdventureUIModel:updateSelectPartnerID(id)
    ...
    EventManager:getInstance():Fire(AdventureEvent.UpdateAdventureSelectHero)
end
...
function AdventureUIModel:setAdventureBaseData(data)
    self.base_data = data
    EventManager:getInstance():Fire(AdventureEvent.Update_Room_Base_Info)
end
...
function AdventureUIModel:setBuffData(data)
	...
	EventManager:getInstance():Fire(AdventureEvent.Update_Buff_Info)
end
...
function AdventureUIModel:setRoomList(data)
	...
	EventManager:getInstance():Fire(AdventureEvent.Update_Room_Info)
end
...
function AdventureUIModel:updateRoomList(data)
    ...
    EventManager:getInstance():Fire(AdventureEvent.Update_Single_Room_Info,data)
end
