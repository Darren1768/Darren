...
function UntieRewardWindow1:open_callback()
    ...
    local res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_banner4_3")
    ...
    if cur_period == 7 then
        res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_banner4_3")
        title_color = cc.c3b(0xf8,0xd3,0x7b)
        text_color = cc.c3b(0x2b,0x19,0x5e)
    elseif cur_period == 8 then
        res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_banner4_2")
        title_color = cc.c3b(0xff,0xe8,0xb8)
        text_color = cc.c3b(0x12,0x2b,0x4d)
    elseif cur_period == 9 then
        res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_banner4")
        title_color = cc.c3b(0xff,0xe8,0xb8)
        text_color = cc.c3b(0x12,0x2b,0x4d)
    else
        res = PathTool.getSingleImgForDownLoad("bigbg/orderaction", "orderaction_banner4")
