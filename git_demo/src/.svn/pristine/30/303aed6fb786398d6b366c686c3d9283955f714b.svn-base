...
function PlanesModel:config()
    ...
    self.is_holiday_open = false --是否活动开启中 
...
function PlanesModel:updatePlanesEvtVoList( data_list )
    ...
    if next(add_evt_vo_list) ~= nil then
        EventManager:getInstance():Fire(PlanesEvent.Add_Evt_Data_Event, add_evt_vo_list)
    end
end
...
function PlanesModel:setPlanesBagData( secret_item )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Iint_Bag_Data_Event)
end
...
function PlanesModel:updatePlanesBagData( data_list )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Update_Bag_Data_Event, data_list, is_add)
end
...
function PlanesModel:deletePlanesBagData( data_list )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Delete_Bag_Data_Event, data_list)
end
...
function PlanesModel:updatePlanesRedStatus( bid, status )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Update_Planes_Red_Event, bid, status)
end
