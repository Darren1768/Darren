...
function EliteSummonPanel:configUI(  )
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/timesummon", str_bg)
...
function EliteSummonPanel:register_event()
    EventManager:getInstance():Bind(EliteSummonEvent.EliteSummon_Message,self,function(data)
