...
function ActionActivityNoticePanel:configUI()
    ...
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/activitynotice", "txt_cn_activity_notice_bg")
...
function ActionActivityNoticeItem:setData( data )
    self.data = data
    local res_image = PathTool.getSingleImgForDownLoad("bigbg/activitynotice", "txt_cn_activity_notice_"..self.data.val,false)
