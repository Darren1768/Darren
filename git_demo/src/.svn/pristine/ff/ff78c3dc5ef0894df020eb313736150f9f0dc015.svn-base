...
function ChatInput:initView()
    ...
    self.edit_box = createEditBox(self, PathTool.getResFrame("mainui", "mainui_chat_input_bg"),editSize, nil, 22, cc.c3b(79, 51, 57), 20, self.default_msg, nil, nil, LOADTEXT_TYPE_PLIST, nil, nil--[[, cc.KEYBOARD_RETURNTYPE_SEND]])
    ...
    self.link_btn = CustomButton.New(self,PathTool.getResFrame("mainui", "mainui_chat_face_icon"),nil,nil,LOADTEXT_TYPE_PLIST)
