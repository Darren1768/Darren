...
function ActionTreasureGetWindow:open_callback()
    ...
    if self.touchTreasure_type == 1 or self.touchTreasure_type == 2 then
        self.btn_left = createImage(self.main_panel, PathTool.getResFrame("common", "hl_common_4.1"), 182, -51, cc.p(0.5,0.5), true, 0, true)
        ...
        self.btn_right = createImage(self.main_panel, PathTool.getResFrame("common", "hl_common_4.1"), 559, -51, cc.p(0.5,0.5), true, 0, true)
    ...
    elseif self.touchTreasure_type == 4 then
        self.btn_left = createImage(self.main_panel, PathTool.getResFrame("common", "hl_common_4.1"), 360, -51, cc.p(0.5,0.5), true, 0, true)
        self.btn_left:setContentSize(cc.size(130,64))
