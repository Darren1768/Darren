...
function AnimateYuanzhenKitchenPanel:register_event()
     EventManager:getInstance():Bind(AnimateActionEvent.YuanZhenFestval_Kitchen,self,function(data)
     ...
     EventManager:getInstance():Bind(AnimateActionEvent.YuanZhenFestval_Kitchen_Lev,self,function(data)
