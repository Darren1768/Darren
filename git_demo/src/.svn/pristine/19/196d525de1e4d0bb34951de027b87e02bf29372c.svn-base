...
function ArenaManyPeopleController:handle29000(data)
    ...
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_MAIN_EVENT, data)
...
function ArenaManyPeopleController:handle29002(data)
    ...
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_INVITATION_PLAYER_EVENT, data)
    end
end
...
function ArenaManyPeopleController:handle29003(data)
    ...
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_INVITATION_LIST_EVENT, data)
end
...
function ArenaManyPeopleController:handle29005(data)
    message(data.msg)
    if data.code == TRUE then
        EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_KEY_CLEAR_EVENT, data)
    end
end
...
function ArenaManyPeopleController:handle29001(data)
    message(data.msg)
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_SEARCH_TEAM_EVENT, data)
end
...
function ArenaManyPeopleController:handle29031(data)
    ...
    if data.code == TRUE then
        ...
        EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_RECEIVE_BOX_EVENT, data)
    end
end
...
function ArenaManyPeopleController:handle29008(data)
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_GET_RECOMMEND_INFO_EVENT, data)
end
...
function ArenaManyPeopleController:handle29010(data)
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_UPDATE_MENBER_EVENT, data)
end
...
function ArenaManyPeopleController:handle29016(data)
    ...
    if data.code == 1 then
        ...
        EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_MATCH_OTHER_EVENT, data)    
    end
end
...
function ArenaManyPeopleController:handle29021(data)
    ...
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_MATCH_MY_EVENT)    
end
...
function ArenaManyPeopleController:handle29025(data)
    ...
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_MAIN_RANK_EVENT,data)    
end
...
function ArenaManyPeopleController:handle29030(data)
    ...
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_UPDATE_BUYNUM_EVENT,data)    
end
...
function ArenaManyPeopleController:handle29026(data)
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_MIAIN_REPORT_EVENT, data)
end
...
function ArenaManyPeopleController:handle29027(data)
    EventManager:getInstance():Fire(ArenaManyPeopleEvent.ARENAMANYPOEPLE_SINGLE_REPORT_EVENT, data)
end
