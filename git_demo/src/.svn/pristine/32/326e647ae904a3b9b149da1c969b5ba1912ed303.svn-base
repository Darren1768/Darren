...
function ActionController:handle13601(data)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVENT_GOAL, data)
end
--请求七日活动领取
...
function ActionController:handle13602(data)
	message(data.msg)
	if data.flag == 1 then
		EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVENT_GET, data)
	end
end
...
function ActionController:on21100(data)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVEN_LOGIN_STATUS, data)
end
...
function ActionController:on21101(data)
	message(data.msg)
	if data.code == 1 then
		EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVEN_LOGIN_REWARDS, data)
		self:cs21100()
	end
end
...
function ActionController:on22700(data)	
	if data.is_cluster == 1 then -- 跨服的
		...
		EventManager:getInstance():Fire(ActionEvent.UPDATE_CROSSSERVER_RANK_LIST,data)
	elseif data.is_cluster == 0 then
		self:openSevenRankWin(true)
		EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVEN_RANK_LIST, data)
	end
end
...
function ActionController:on22701(data)
	...
	if b then -- 是否跨服的id
		EventManager:getInstance():Fire(ActionEvent.UPDATE_CROSSSERVER_RANK_DATA, data)
	else
		EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVEN_RANK_DATA, data)
	end
...
function ActionController:on16601(data)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_ACTION_DATA_EVENT)
...
function ActionController:setHolidayStatus(bid, status)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_HOLIDAY_TAB_STATUS, function_id, vo)
end
...
function ActionController:on22703(data)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_SEVENT_QUEST)
end
...
function ActionController:handle16637(data)
	...
	EventManager:getInstance():Fire(ActionEvent.UPDATE_LUCKYROUND_GET, data)
end
...
function ActionController:handle16638(data)
	EventManager:getInstance():Fire(ActionEvent.TREASURE_SUCCESS_DATA, data)
end

function ActionController:handle16639(data)
	EventManager:getInstance():Fire(ActionEvent.UPDATE_LUCKLY_DATA, data)
end
...
function ActionController:handle16641(data)
	EventManager:getInstance():Fire(ActionEvent.UPDATA_TREASURE_LOG_DATA, data)
end
...
function ActionController:handle16642(data)
	message(data.msg)
	-- EventManager:getInstance():Fire(ActionEvent.UPDATA_TREASURE_REFRESH, data)
end
--弹窗的
...
function ActionController:handle16643(data)
	message(data.msg)
	if data.code == 1 then
		EventManager:getInstance():Fire(ActionEvent.UPDATA_TREASURE_POPUPS_SEND, data)
	end
end
...
function ActionController:handle21200(data)
	EventManager:getInstance():Fire(ActionEvent.UPDATE_LEVEL_UP_GIFT, data)
end
...
function ActionController:handle21210(data)
	message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.LIMIT_GIFT_MAIN_EVENT, data)
end
...
function ActionController:handle16650(data)
	message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.RANK_REWARD_LIST, data)
end
...
function ActionController:handle24700( data )
	if data and data.ids then
		...
		EventManager:getInstance():Fire(ActionEvent.UPDATA_FUND_ID_LIST_EVENT)
	end
end
...
function ActionController:handle24701( data )
	if data then
		...
		EventManager:getInstance():Fire(ActionEvent.UPDATA_FUND_DATA_EVENT, data.id)
	end
end
...
function ActionController:handle24810( data )
	message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.YUAN_ZHEN_DATA_EVENT, data)
end

--推送任务
function ActionController:handle24811( data )
	EventManager:getInstance():Fire(ActionEvent.YUAN_ZHEN_UPDATA_EVENT, data)
end
...
function ActionController:handle24812( data )
	...
	if data.code == TRUE then
		EventManager:getInstance():Fire(ActionEvent.YUAN_ZHEN_TASK_EVENT, data)
	end
end
--------------------元宵冒险协议结束-------------------------------------
--试炼之境
...
function ActionController:handle27300( data )
	EventManager:getInstance():Fire(ActionEvent.Merge_Aim_Event, data) -- 
end
...
function ActionController:handle27301( data )
	EventManager:getInstance():Fire(ActionEvent.Merge_Box_Status_Event, data)
end
...
function ActionController:handle21016(data)
	EventManager:getInstance():Fire(ActionEvent.Is_Charge_Event, data)
end
...
function ActionController:handle16688(data)
    ...
    EventManager:getInstance():Fire(ActionEvent.UPDATE_STORE_DATA_EVENT)
end
...
function ActionController:handle16689(data)
	message(data.msg)
	if data.code == 1 then
		EventManager:getInstance():Fire(ActionEvent.UPDATE_STORE_DATA_SUCCESS_EVENT,data)
	end
end
--------------------新服限购协议结束-------------------------------------
...
function ActionController:handle25400(data)
    EventManager:getInstance():Fire(ActionEvent.Aandybeach_Boss_Fight_Action_Event, data)
end
...
function ActionController:handle25401(data)
    ...
    EventManager:getInstance():Fire(ActionEvent.Aandybeach_Boss_Fight_Main_Event, data)
end
--购买挑战次数"
...
function ActionController:handle25402(data)
    ...
    if data.code == 1 then
        ...
        EventManager:getInstance():Fire(ActionEvent.Aandybeach_Boss_Fight_Buy_Count_Event, data)
    end
end
...
function ActionController:handle25403(data)
    EventManager:getInstance():Fire(ActionEvent.Aandybeach_Boss_Fight_Reward_Event, data)
end
...
function ActionController:handle25500(data)
	...
	EventManager:getInstance():Fire(ActionEvent.Updata_Hero_Clothes_Shop_Data,data)
end
...
function ActionController:handle11071(data)
	message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.ACTION_HERO_RESET_EVENT, data)
end
...
function ActionController:handle11072(data)
	message(data.msg)
	if data.code == TRUE then
		EventManager:getInstance():Fire(ActionEvent.ACTION_HERO_RESET_ITEM_EVENT, data)
	end
end
...
function ActionController:handle26600(data)
	...
	if data.flag == 1 then
		...
		EventManager:getInstance():Fire(ActionEvent.ACTION_SKIN_LOTTERY_GET,data)
	end
end
...
function ActionController:handle26601(data)
	EventManager:getInstance():Fire(ActionEvent.ACTION_SKIN_LOTTERY_MSG,data)
...
function ActionController:handle26602( data )
	if data then
		local function func()
			EventManager:getInstance():Fire(ActionEvent.ACTION_SKIN_LOTTERY_REWARD)
		end
...
function ActionController:handle21020( data )
	if data and data.status == 1 then
		EventManager:getInstance():Fire(ActionEvent.ACTION_PERFER_ISOPEN,data.status)
	end
end
...
function ActionController:handle28100( data )
	if data then
		EventManager:getInstance():Fire(ActionEvent.UPDATE_RECHARGE_REBATE_EVENT, data)
	end
end
...
function ActionController:handle26530( data )
	message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.SPRITE_RESET_EVENT,data)
end
...
function ActionController:handle28400( data )
	...
	EventManager:getInstance():Fire(ActionEvent.LUCKY_DOG_BASE_EVENT)
...
function ActionController:handle28300( data )
	if data then
		EventManager:getInstance():Fire(ActionEvent.FORTUNE_BAG_DRAW_BASE_EVENT, data)
	end
end
...
function ActionController:handle28301( data )
	if data then
		EventManager:getInstance():Fire(ActionEvent.FORTUNE_BAG_SURPLUS_EVENT, data)
	end
end
...
function ActionController:handle28303( data )
	if data then
		EventManager:getInstance():Fire(ActionEvent.FORTUNE_BAG_ULTIMATE_EVENT, data)
	end
end
...
function ActionController:handle16697( data )
	...
	-- message(data.msg)
	EventManager:getInstance():Fire(ActionEvent.Update_Time_Collect_Main_Icon_Event,data.code)
end
...
function ActionController:handle28500( data )
	...
	EventManager:getInstance():Fire(ActionEvent.Update_Sweet_Data_Event)
end
...
function ActionController:handle28502( data )
	...
	if data.code == TRUE then
		EventManager:getInstance():Fire(ActionEvent.Sweet_Put_Success_Event, data.id)
	end
end
...
function ActionController:handle28800(data)
	...
	EventManager:getInstance():Fire(ActionEvent.White_Day_Init_Event, data)
end
...
function ActionController:handle16653(data)
	...
	EventManager:getInstance():Fire(ActionEvent.SuperValueWeeklyCard_Init_Event, data)
end
