...
function ActionSuperValueWeeklyCardPanel:loadResources()
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("superweekcard", "superweekcard_bg"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("superweekcard", "superweekcard_time_bg"), type = ResourcesType.single}
    }
...
function ActionSuperValueWeeklyCardPanel:register_event()
    ...
    EventManager:getInstance():Bind(ActionEvent.SuperValueWeeklyCard_Init_Event,self, function(data) self:setData(data) end)


    EventManager:getInstance():Bind(ActionEvent.Is_Charge_Event,self,
        function(data)
