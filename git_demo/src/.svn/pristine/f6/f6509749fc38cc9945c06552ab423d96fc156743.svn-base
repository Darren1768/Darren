...
function AdventureMineWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/adventure", "adventure_mine_bg", true), type = ResourcesType.single},
    }
...
function AdventureMineWindow:open_callback()
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/adventure", "adventure_mine_bg", true), LOADTEXT_TYPE)
