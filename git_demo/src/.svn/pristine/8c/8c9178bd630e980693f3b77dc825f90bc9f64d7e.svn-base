...
function SysController:requestLoginProtocals(  )
	...
	local delay_fun_list = {
		...
		function () self:SendProtocal(29300, {}) end,   --请求探索历练界面
		function () self:SendProtocal(29309, {}) end,   --请求探索历练界面状态阶段


		function () self:SendProtocal(29606, {}) end,   --请求我的队伍
		function () self:SendProtocal(29702, {}) end,   --请求队伍支援
		function () self:SendProtocal(29709,{})  end,   --请求玩家关系数据	
	}
...
function SysController:requestReLinkProtocals(  )
	local delay_fun_list = {
		...
		function () self:SendProtocal(25232, {}) end,   --战力前五神装总评分
		function () self:SendProtocal(10985, {}) end,   --红点系列已点过的红点
		function () self:SendProtocal(29300, {}) end,   --请求探索历练界面数据
		function () self:SendProtocal(29309, {}) end,   --请求探索历练界面状态阶段

		function () self:SendProtocal(29606, {}) end,   --请求我的队伍
		function () self:SendProtocal(29702, {}) end,   --请求队伍支援
		function () self:SendProtocal(29709,{})  end,   --请求玩家关系数据
		function () self:SendProtocal(29711,{})  end,   --关系buff加成
