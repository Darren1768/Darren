...
BattleNationalWarNameItem = BattleNationalWarNameItem or BaseClass()

function BattleNationalWarNameItem:__init(data, area_type)
	self.data = data or {}
	self.area_type = 1
...
function BattleNationalWarNameItem:createRootwnd()
...
function BattleNationalWarNameItem:onClickBuild()
...
function BattleNationalWarNameItem:setParentWnd(parent)
...
function BattleNationalWarNameItem:setBaseData(data)

end

function BattleNationalWarNameItem:getData()
	return self.data
end

function BattleNationalWarNameItem:getRoot()
	return self.root
end

function BattleNationalWarNameItem:__delete()
