...
function AnimateYuanzhenGotoKitchenWindow:__init(holiday_id,make_lev,holiday_reward_bid,cur_exp)
    ...
    self.res_list = {
        ...
        { path = PathTool.getSingleImgForDownLoad("bigbg/animateaction/barner","animateaction_barner_1"), type = ResourcesType.single},
    }
end
...
function AnimateYuanzhenGotoKitchenItem:configUI()
    ...
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("animateaction/animate_yuanzhen_goto_kitchen_item"))
