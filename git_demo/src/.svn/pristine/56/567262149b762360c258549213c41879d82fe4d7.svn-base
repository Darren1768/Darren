...
function ActiontermbeginsFightResultPanel:open_callback()
    ...
    self.comfirm_btn = createTypeButton(self.container,TI18N("确 定"), 620, 500, ButtonType.yellow)
    ...
    self.cancel_btn = createTypeButton(self.container,TI18N("返回玩法"), 620, 500, ButtonType.red)
