...
function CrossshowMainWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/crossshow", "crossshow_bg", true), type = ResourcesType.single}
    }
...
function CrossshowMainWindow:open_callback(  )
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/crossshow", "crossshow_bg", true), LOADTEXT_TYPE)
