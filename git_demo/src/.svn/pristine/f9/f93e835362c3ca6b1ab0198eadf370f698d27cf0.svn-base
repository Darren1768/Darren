...
function ActivePushWindow:__init()
    ...
    self.res_list = {
        -- {path = PathTool.getSingleImgForDownLoad("activepush", "activepush_bg1", false), type = ResourcesType.single},
        -- {path = PathTool.getSingleImgForDownLoad("activepush", "activepush_bg2", false), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("activepush", "activepush_bg3", false), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("activepush", "activepush_bg4", false), type = ResourcesType.single}
    }
end
...
function ActivePushWindow:initUI()
    if self.push_id and self.close_btn and self.close_btn.loadTexture and self.goto_btn and self.goto_btn.loadTexture then
        if self.push_id == 1 then
            ...
            self.goto_btn:loadTexture(PathTool.getResFrame("common", "hl_common_4"), LOADTEXT_TYPE_PLIST)
        ...
        elseif self.push_id == 2 then
            ...
            self.goto_btn:loadTexture(PathTool.getResFrame("common", "hl_common_4.1"), LOADTEXT_TYPE_PLIST)
