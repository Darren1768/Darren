...
function AdventureEvtShopView:__init(data) 
    ...
    self.res_list = {
        { path = PathTool.getSingleImgForDownLoad("bigbg", "bigbg_55"), type = ResourcesType.single},
...
function AdventureEvtShopView:createShopItem(index, start_x, cell_width, space, id)
    ...
    local button = createImage(node, PathTool.getResFrame("common", "hl_common_4.1"), 50, -20, cc.p(0.5, 0.5), true, 1, true) 
