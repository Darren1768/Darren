...
function AnimateActionController:handle24801(data)
	EventManager:getInstance():Fire(AnimateActionEvent.YuanZhenFestval_Linght,data)
end
--元宵灯会奖池信息
...
function AnimateActionController:handle24802(data)
	message(data.msg)
	if data.flag == 1 then
		EventManager:getInstance():Fire(AnimateActionEvent.YuanZhenFestval_Lottery,data)
	end
end
--元宵灯会抽奖
...
function AnimateActionController:handle24804(data)
	...
	EventManager:getInstance():Fire(AnimateActionEvent.YuanZhenFestval_Kitchen,data)
end
--制作物品
...
function AnimateActionController:handle24805(data)
	...
	EventManager:getInstance():Fire(AnimateActionEvent.YuanZhenFestval_Kitchen_Lev,data)
end
--领取等级礼包
...
function AnimateActionController:handle24809(data)
	message(data.msg)
	if data.flag == 1 then
		EventManager:getInstance():Fire(AnimateActionEvent.YuanZhenFestval_Buy_Challage,data)
	end
end
--收集食材
