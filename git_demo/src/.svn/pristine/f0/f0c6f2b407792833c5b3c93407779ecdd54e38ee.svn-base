...
Proto.send = {
   ...
   [11033] = {
      {name='partner_id', type='uint32'},
      {name='strengthen_time', type='uint32'}
   },
   [11034] = {
      {name='partner_id', type='uint32'}
   },
   ...
   [29308] = {
      {name='id', type='uint32'},
      {name='atk_league_id', type='uint32'},
      {name='atk_league_srv_id', type='string'}
   },
   [29309] = {
   },
   [29310] = {
   ...
   [29312] = {
      {name='id', type='uint32'},
      {name='type', type='uint8'},
      {name='embattled_type', type='uint8'}
   },
   [29313] = {
      {name='id', type='uint32'}
   },
   ...
   [29601] = {
      {name='htid', type='uint32'},
      {name='htsrv_id', type='string'},
      {name='type', type='uint8'}
   },
   [29602] = {
      {name='type', type='uint8'},
   ...
   [29704] = {
      {name='type', type='uint32'},
      {name='pid_list', type='array', fields={
...
Proto.recv = {
   ...
   [10301] = {
      ...
      {name='lid', type='uint32'},
      {name='lsrv_id', type='string'},
      {name='league_position', type='uint8'},
      {name='lname', type='string'},
      {name='league_lev', type='uint8'},
      {name='league_quit_time', type='uint32'}
   },
   [10302] = {
      {name='lev', type='uint16'},
      ...
      {name='union_coin', type='uint32'},
      {name='league_explore', type='uint32'}
   },
   [10304] = {
   ...
   [11000] = {
      ...
      {name='partners', type='array', fields={
          ...
          {name='star_skill_lev', type='uint32'},
          ...
          {name='spiritbody_id', type='uint32'},
          {name='spiritbody_skills', type='array', fields={
              {name='skill_id', type='uint32'}
          }},
          {name='spiritbody_level', type='uint32'},
          {name='spiritbody_star', type='uint32'},
          {name='base_attr', type='array', fields={
              {name='attr_id', type='uint32'},
              {name='attr_val', type='uint32'}
          }},
          {name='level_attr', type='array', fields={
              {name='level_extra_k', type='uint32'},
              {name='level_extra_v', type='uint32'}
          }},
          {name='star_attr', type='array', fields={
              {name='star_extra_k', type='uint32'},
              {name='star_extra_v', type='uint32'}
          }},
   ...
   [13000] = {
      ...
      {name='mode_list', type='array', fields={
          ...
          {name='chapter_list', type='array', fields={
              {name='chapter_id', type='uint8'},
              {name='status', type='uint8'},
              {name='map_list', type='array', fields={
                  {name='map_id', type='uint32'},
   ...
   [23800] = {
      ...
      {name='order_times', type='uint8'},
      {name='max_order_times', type='uint8'}
   },
   [23801] = {
      {name='order_id', type='uint32'},
      {name='order_bid', type='uint32'},
   ...
   [23900] = {
      ...
      {name='max_round_individual', type='uint16'},
      {name='current_round_individual', type='uint16'},
      {name='day_pass_round_individual', type='uint16'},
      {name='now_current_round_individual', type='uint16'},
      {name='my_idx_individual', type='uint16'},
      {name='rank_list_individual', type='array', fields={
          {name='idx', type='uint8'},
          {name='name', type='string'},
          {name='rid', type='uint32'},
          {name='srv_id', type='string'},
      ...
      {name='is_reward_individual', type='uint8'},
      {name='hero_max_level', type='uint8'}
   },
   [23901] = {
      {name='code', type='uint8'},
      {name='msg', type='string'}
   ...
   [29218] = {
      ...
      {name='name', type='string'},
      {name='lev', type='uint8'},
      {name='guild_members', type='array', fields={
          {name='gid', type='uint32'},
          {name='gsrv_id', type='string'}
      }},
      {name='members_num', type='uint8'},
      {name='guild_num', type='uint8'},
      {name='guild_max', type='uint8'},
      {name='leader_name', type='string'},
      {name='rid', type='uint32'},
      {name='srv_id', type='string'},
      {name='sign', type='string'},
   ...
   [29300] = {
      ...
      {name='resources', type='array', fields={
          {name='id', type='uint32'},
          {name='league_id', type='uint32'},
          {name='league_srv_id', type='string'},
   ...
   [29304] = {
      ...
      {name='id', type='uint32'},
      {name='type', type='uint8'},
      {name='embattled', type='array', fields={
          {name='rid', type='uint32'},
          {name='srv_id', type='string'},
          {name='pos', type='uint32'},
          {name='name', type='string'},
   ...
   [29306] = {
      ...
      {name='atk_league_id', type='uint32'},
      {name='atk_league_srv_id', type='string'},
      {name='atk_league_name', type='string'},
      {name='atk_league_lev', type='uint8'},
      {name='atk_score', type='uint32'},
      {name='atk_embattled', type='array', fields={
          {name='rid', type='uint32'},
          {name='srv_id', type='string'},
          {name='pos', type='uint32'},
          {name='name', type='string'},
      ...
      {name='def_league_id', type='uint32'},
      {name='def_league_srv_id', type='string'},
      {name='def_league_name', type='string'},
      {name='def_league_lev', type='uint8'},
      {name='def_score', type='uint32'},
      {name='def_embattled', type='array', fields={
          {name='rid', type='uint32'},
          {name='srv_id', type='string'},
          {name='pos', type='uint32'},
          {name='name', type='string'},
   ...
   [29307] = {
      {name='code', type='uint8'},
      {name='msg', type='string'},
      {name='league_rank', type='array', fields={
          {name='rank', type='uint8'},
          {name='result', type='uint8'},
          {name='atk_league_id', type='uint32'},
          {name='atk_league_srv_id', type='string'},
   ...
   [29311] = {
      ...
      {name='srv_id', type='string'},
      {name='replay_list', type='array', fields={
          {name='oppo_rid', type='uint32'},
          {name='oppo_srv_id', type='string'},
          {name='replay_id', type='uint32'},
          {name='replay_srv_id', type='string'}
      }}
   },
   ...
   [29315] = {
      ...
      {name='info', type='array', fields={
          ...
          {name='day_timestamp', type='uint32'},
          {name='week_status', type='uint8'},
          {name='week_timestamp', type='uint32'}
      }}
   },
   [29316] = {
      {name='code', type='uint8'},
   ...
   [29600] = {
      ...
      {name='all_count', type='uint16'},
      {name='name', type='string'},
      {name='hook_team_teams', type='array', fields={
          {name='htid', type='uint32'},
          {name='htsrv_id', type='string'},
          {name='name', type='string'},
          {name='leader_face', type='uint32'},
          {name='leader_lev', type='uint16'},
          {name='leader_vip', type='uint8'},
          {name='leader_guild_name', type='string'},
          {name='leader_arena_elite_lev', type='uint32'},
          {name='power', type='uint32'},
          {name='members_num', type='uint8'},
          {name='members_max', type='uint8'},
          {name='leader_avatar_bid', type='uint32'},
   ...
   [29606] = {
      {name='htid', type='uint32'},
      {name='htsrv_id', type='string'},
      {name='htleaderid', type='uint32'},
      {name='htleadersrv_id', type='string'},
      {name='name', type='string'},
      {name='lev', type='uint8'},
      {name='members_num', type='uint8'},
      {name='members_max', type='uint8'},
   ...
   [29615] = {
      {name='hook_team_log_info_list', type='array', fields={
          {name='id', type='uint8'},
          {name='htid', type='uint32'},
          {name='htsrv_id', type='string'},
          {name='type', type='uint8'},
   ...
   [29709] = {
      {name='relation_list', type='array', fields={
          {name='rid', type='uint32'},
          {name='srv_id', type='string'},
