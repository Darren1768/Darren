...
function HolynightMainWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("monopoly","monopoly_enter_bg_1",true), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("monopoly","monopoly_enter_bg_2"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("monopoly/build","build_1"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("monopoly/build","build_2"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("monopoly/build","build_3"), type = ResourcesType.single},
        {path = PathTool.getSingleImgForDownLoad("monopoly/build","build_4"), type = ResourcesType.single},
    }
