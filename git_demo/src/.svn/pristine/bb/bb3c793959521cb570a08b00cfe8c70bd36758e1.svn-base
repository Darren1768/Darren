...
function PlanesafkOrderactionWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("planes","planes_bg",true), type = ResourcesType.single},
    }
...
function PlanesafkOrderActiodRewardItem:configUI()
    self.root_wnd = createCSBNote(PathTool.getTargetCSB("planesafk/planesafk_orderaction_reward_item"))
