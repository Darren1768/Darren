...
function PlanesController:handle23100( data )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Update_Dun_Base_Event)
end
...
function PlanesController:handle23101( data )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Update_Map_Data_Event, data)
end
...
function PlanesController:handle23102( data )
    ...
    if data.tile_list and next(data.tile_list) ~= nil then
        ...
        -- 更新格子
        EventManager:getInstance():Fire(PlanesEvent.Update_Grid_Event, data.tile_list)
    end
end
...
function PlanesController:handle23103( data )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Update_Role_Grid_Event, data)
end
    ...
    if evt_vo and evt_vo.config and evt_vo.config.group_id ~= 0 and action == 1 then -- 多选一事件，要弹出确认框
        ...
        if next(show_break_index_list) == nil then
            ...
            self.confirm_alert = CommonAlert.show(tips_str, TI18N("确认"), function (  )
                ...
                EventManager:getInstance():Fire(PlanesEvent.Show_Break_Effect_Event, show_break_index_list)
...
function PlanesController:handle23109( data )
    EventManager:getInstance():Fire(PlanesEvent.Get_Master_Data_Event, data)
end
...
function PlanesController:handle23115( data )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Get_All_Hero_Event)
end
...
function PlanesController:handle23116( data )
    ...
    EventManager:getInstance():Fire(PlanesEvent.Look_Other_Hero_Event, data)
end
...
function PlanesController:handle23117( data )
    ...
    if data.flag == 1 and data.dun_id then -- 领取成功
        ...
        EventManager:getInstance():Fire(PlanesEvent.Get_First_Award_Event)
    end
end
...
function PlanesController:handle23118( data )
    EventManager:getInstance():Fire(PlanesEvent.Get_Buff_Data_Event, data.buffs)
end
...
function PlanesController:handle23120( data )
    EventManager:getInstance():Fire(PlanesEvent.Update_Form_Atk_Event, data.power)
end
...
function PlanesController:handle23121( data )
    ...
    if data.flag == 1 then
        EventManager:getInstance():Fire(PlanesEvent.Save_Form_Success_Event) 
    end
end
...
function PlanesController:handle23122( data )
    EventManager:getInstance():Fire(PlanesEvent.Get_Form_Data_Event, data) 
end
