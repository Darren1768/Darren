...
function CommonAlert:__init(type, title, is_auto_close, is_show_title, view_tag, win_type,close_callback)
    ...
    self.layout_name = "common/common_ui_alert"
...
function CommonAlert:openCallBack()
    ...
    if self.cancel_label then
        ...
        self.ok_btn:setPositionX(self.main_panel:getContentSize().width * 0.5)
    end
end
