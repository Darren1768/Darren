...
function ElfinLvUpWindow:__init()
	...
	self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("elfin","elfin_egg_icon"), type = ResourcesType.single },
		{path = PathTool.getSingleImgForDownLoad("elfin","elfin_bottom_bg"), type = ResourcesType.single },
	}
end
