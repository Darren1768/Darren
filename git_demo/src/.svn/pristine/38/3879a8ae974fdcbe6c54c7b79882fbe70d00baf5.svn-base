...
function SandybeachBossFightMainWindow:__init()
    ...
    self.res_list = { 
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_1"), type = ResourcesType.single}
    }
...
function SandybeachBossFightMainWindow:loadBackground()
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_1")
    ...
    local bg_res1 = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_2")
...
function SandybeachBossFightMainWindow:loadRoleLevelStep()
    ...
    for i=1, step_count do
        delayRun(self.action_panel, i*5/60, function()
            local step_res = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_3")
...
function SandybeachBossFightMainWindow:onClickRankBtn()
    ...
    setting.background_path = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_1")
...
function SandybeachBossFightMainWindow:updateSpine(unit_id)
    ...
    if not self.load_rolespine_bg then
        local res = PathTool.getSingleImgForDownLoad("bigbg/sandybeachbossfight", "sandybeach_4")
