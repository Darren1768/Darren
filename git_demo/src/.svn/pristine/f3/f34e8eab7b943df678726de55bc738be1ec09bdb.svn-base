...
function HomeworldMyPlanItem:configUI(  )
    ...
    self.image_bg = createSprite(PathTool.getResFrame("common", "hl_common_91"), self.size.width*0.5, self.size.height*0.5+20, self.container, cc.p(0.5, 0.5), LOADTEXT_TYPE_PLIST)
end
