...
function BattleResultReturnMgr:returnByFightType(fight_type)
    ...
    if cur_win == nil then
        ...
        elseif fight_type == BattleConst.Fight_Type.Spirit then --试练塔
        ...
        elseif fight_type == BattleConst.Fight_Type.LeagueExplore then -- 探索历练
            MainuiController:getInstance():changeMainUIStatus(MainuiConst.btn_index.main_scene, MainuiConst.sub_type.league_explore)
        else
