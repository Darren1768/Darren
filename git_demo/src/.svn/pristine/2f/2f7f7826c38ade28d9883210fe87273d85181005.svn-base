...
function EmpolyPanel:open_callback()
    ...
    self.empty_bg = createSprite(PathTool.getSingleImgForDownLoad("bigbg", "bigbg_3"), good_cons:getContentSize().width*0.5, good_cons:getContentSize().height*0.5, good_cons, cc.p(0.5, 0.5), LOADTEXT_TYPE)
