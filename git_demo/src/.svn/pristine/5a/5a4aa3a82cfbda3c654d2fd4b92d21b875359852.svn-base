...
function LadderAwardWindow:__init()
	...
	self.layout_name = "ladder/ladder_award_common_window"
...
function LadderAwardItem:configUI(  )
	...
	local csbPath = PathTool.getTargetCSB("ladder/ladder_award_common_item")
...
function LadderAwardItem:setData( data )
	...
	if data.min == 1 then
		...
		self.image:loadTexture(PathTool.getResFrame("common","hl_common_2000"), LOADTEXT_TYPE_PLIST)
	elseif data.min == 2 then
		self.image:setVisible(true)
		self.rank_label:setVisible(false)
		self.image:loadTexture(PathTool.getResFrame("common","hl_common_2001"), LOADTEXT_TYPE_PLIST)
	elseif data.min == 3 then
		self.image:setVisible(true)
		self.rank_label:setVisible(false)
		self.image:loadTexture(PathTool.getResFrame("common","hl_common_2002"), LOADTEXT_TYPE_PLIST)
	else
