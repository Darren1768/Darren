...
function ArenaEnterLoopView:handleEvent(status)
    ...
    EventManager:getInstance():UnBind(self)
     ...
     EventManager:getInstance():Bind(ArenaEvent.UpdateMyLoopData,self, function() 
                self:updateMyData()
            end)
     EventManager:getInstance():Bind(ArenaEvent.UpdateLoopChallengeStatueList,self, function(list)
