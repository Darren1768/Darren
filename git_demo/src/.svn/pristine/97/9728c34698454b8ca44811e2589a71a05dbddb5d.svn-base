...
function TimesummonController:handle23216( data )
	if data then
		EventManager:getInstance():Fire(TimesummonEvent.Update_Summon_Data_Event, data)
	end
end
...
function TimesummonController:handle26521( data )
	if data then
		EventManager:getInstance():Fire(TimesummonEvent.Update_Elfin_Summon_Data_Event, data)
	end
end
...
function TimesummonController:handle26525( data )
	...
	if self.is_return_gain == true then
		...
		EventManager:getInstance():Fire(TimesummonEvent.Update_Elfin_Item_Event, data)
	else
		EventManager:getInstance():Fire(TimesummonEvent.Update_Elfin_Summon_Rewards_Data_Event, data)
	end
