...
function GuildWarRankWindow:open_callback(  )
    ...
    local res_id = PathTool.getSingleImgForDownLoad('bigbg/rank', 'rank_2')
...
function GuildWarRankWindow:register_event(  )
    ...
    EventManager:getInstance():Bind(GuildwarEvent.UpdateGuildWarRankDataEvent,self, function( data )
