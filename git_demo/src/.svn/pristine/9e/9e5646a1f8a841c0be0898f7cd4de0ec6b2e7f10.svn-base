...
function LadderController:handle24300( data )
	...
	EventManager:getInstance():Fire(LadderEvent.UpdateLadderMyBaseInfo)
end
...
function LadderController:handle24301( data )
	if data then
		...
		EventManager:getInstance():Fire(LadderEvent.UpdateAllLadderEnemyList)
	end
end
...
function LadderController:handle24302( data )
	if data then
		EventManager:getInstance():Fire(LadderEvent.GetLadderEnemyData, data)
	end
end
...
function LadderController:handle24308( data )
	if data and data.rank_list then
		EventManager:getInstance():Fire(LadderEvent.UpdateLadderTopThreeRoleData, data.rank_list)
	end
end
...
function LadderController:handle24309( data )
	if data then
		EventManager:getInstance():Fire(LadderEvent.UpdateLadderRankData, data)
	end
end
...
function LadderController:handle24310( data )
	if data then
		EventManager:getInstance():Fire(LadderEvent.UpdateLadderMyLogData, data)
	end
end
...
function LadderController:handle24311( data )
	if data then
		EventManager:getInstance():Fire(LadderEvent.UpdateLadderGodLogData, data)
	end
end
...
function LadderController:handle24312( data )
	if data then
		...
		EventManager:getInstance():Fire(LadderEvent.UpdateLadderOpenStatus)
	end
end
