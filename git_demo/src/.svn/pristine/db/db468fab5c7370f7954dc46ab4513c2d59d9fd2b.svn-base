...
function PlumeShopWindow:__init()
    ...
    self.res_list = {
		...
		{path = PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_shop_bg", true), type = ResourcesType.single},
...
function PlumeShopWindow:open_callback( )
    ...
    if self.background ~= nil then
    	self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_shop_bg", true), LOADTEXT_TYPE)
	...
	loadSpriteTexture(top_sp, PathTool.getSingleImgForDownLoad("bigbg/welfare","welfare_shop_top"), LOADTEXT_TYPE)
