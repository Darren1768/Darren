...
function HeavenController:handle25200( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Get_Chapter_Data_Event)
	end
end
...
function HeavenController:handle25201( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Update_Chapter_Basedata_Event)
	end
end
...
function HeavenController:handle25203( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Update_Chapter_Count_Event)
	end
end
...
function HeavenController:handle25210( data )
	EventManager:getInstance():Fire(HeavenEvent.Update_Heaven_Fun_Form, data)
...
function HeavenController:handle25211( data )
	if data then
		message(data.msg)
		EventManager:getInstance():Fire(HeavenEvent.Save_Heaven_Fun_Form, data)
	end
end
...
function HeavenController:handle25215( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Get_Chapter_Award_Event)
	end
end
...
function HeavenController:handle25218( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Update_Dial_Record_Data, data.type, data.group_id)
	end
end
...
function HeavenController:handle25219( data )
	if data then
		...
		EventManager:getInstance():Fire(HeavenEvent.Update_Dial_Base_Data)
	end
end
