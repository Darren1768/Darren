...
function BattleConst.getShareTypeByBattleType( battle_type )
    ...
    elseif battle_type == BattleConst.Fight_Type.Spirit then
    ...
    elseif battle_type == BattleConst.Fight_Type.LeagueExplore then --探索历练
        return BattleConst.ShareType.ShareLeagueExplore
    end
end
...
function BattleConst.getUIFightByFightType(fight_type)
    ...
    elseif fight_type == BattleConst.Fight_Type.LeagueExplore then -- 探索历练
        btn_type = MainuiConst.ui_fight_type.leagueexplore
    end
    return  btn_type
end
