...
function ArenateamMainWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getSingleImgForDownLoad("bigbg/battle_bg/10032", "b_bg", true), type = ResourcesType.single},
    }
...
function ArenateamMainWindow:open_callback(  )
    ...
    self.background:loadTexture(PathTool.getSingleImgForDownLoad("bigbg/battle_bg/10032", "b_bg", true), LOADTEXT_TYPE)
...
function ArenateamMainWindow:onClickShopBtn(  )
    MallController:getInstance():openMallPanel(true, MallConst.MallType.CrossarenaShop)
end
            ...
            if member_data then
                ...
                if head.record_res_bid == nil or head.record_res_bid ~= avatar_bid then
                    ...
                    if vo then
                        ...
                        local bgRes = PathTool.getResFrame("common","hl_common_40")
...
function ArenateamMainItem:setData(data, index)
    ...
    if index == 1 then
        ...
        loadSpriteTexture(self.sprite, PathTool.getResFrame("common","hl_common_2000"), LOADTEXT_TYPE_PLIST)
    elseif index == 2 then
        self.sprite:setVisible(true)
        self.team_index:setVisible(false)
        loadSpriteTexture(self.sprite, PathTool.getResFrame("common","hl_common_2001"), LOADTEXT_TYPE_PLIST)
    elseif index == 3 then
        self.sprite:setVisible(true)
        self.team_index:setVisible(false)
        loadSpriteTexture(self.sprite, PathTool.getResFrame("common","hl_common_2002"), LOADTEXT_TYPE_PLIST)
    else
