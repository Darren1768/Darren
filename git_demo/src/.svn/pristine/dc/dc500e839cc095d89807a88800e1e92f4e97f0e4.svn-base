...
function UnionSendMailWindow:register_event()
    registerButtonEventListener(self.background, function()
        controller:openUnionSendMailWindow(false)
    end, false, 2)
...
function UnionSendMailWindow:openRootWnd()
end

function UnionSendMailWindow:close_callback()
    controller:openUnionSendMailWindow(false)
end
