...
function SmasheggController:handle16680( data )
	if data then
		EventManager:getInstance():Fire(SmasheggEvent.Update_Smashegg_Data_Event, data)
	end
end
...
function SmasheggController:handle16685( data )
	if data then
		...
		EventManager:getInstance():Fire(SmasheggEvent.Update_Smashegg_Record_Event, data)
	end
end
