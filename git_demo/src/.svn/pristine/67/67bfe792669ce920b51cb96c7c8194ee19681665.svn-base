...
function HomePetRewardPanel:__init()
    ...
    self.res_list = {
        ...
        -- {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_item_bg"), type = ResourcesType.single},
        -- {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_closed"), type = ResourcesType.single},
        -- {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_open"), type = ResourcesType.single},
        -- {path = PathTool.getSingleImgForDownLoad("bigbg/homepet", "txt_cn_home_pet_get_world"), type = ResourcesType.single}
    }
...
function HomePetRewardPanel:openRootWnd(setting)
    ...
    local title_res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_closed", false)
...
function HomePetRewardPanel:showOpenEffect()
    local title_res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_open", false)
...
function ShowItemObj:showItemUI(data, extend)
    ...
    if item_config ~= nil then
        ...
        -- local res = PathTool.getSingleImgForDownLoad("bigbg/homepet", "home_pet_reward_item_bg")
