...
function RoleAchieveWindow:__init(view_tag)
    ...
    self.res_list = {
        {path = PathTool.getSingleImgForDownLoad("bigbg/rolepersonalspace", "txt_cn_task_achieve", false), type = ResourcesType.single}
    }
...
function RoleAchieveWindow:open_callback()
    ...
    bg:setScale(1.5)
    local bg_res = PathTool.getSingleImgForDownLoad("bigbg/rolepersonalspace", "txt_cn_task_achieve")
