...
function RecruitHeroWindow:__init()
	...
	self.res_list = {
		{path = PathTool.getSingleImgForDownLoad("bigbg/action","action_bigbg_3"), type = ResourcesType.single},
...
function RecruitHeroWindow:open_callback()
	...
	local res = PathTool.getSingleImgForDownLoad("bigbg/action", "action_bigbg_3")
