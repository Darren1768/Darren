...
Config.MarketSilverData.data_market_sliver_cost_fun = function(key)
	local data=Config.MarketSilverData.data_market_sliver_cost[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketSilverData.data_market_sliver_cost['..key..'])not found') return
	end
	return data
end
...
Config.MarketSilverData.data_antique_list_fun = function(key)
	local data=Config.MarketSilverData.data_antique_list[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketSilverData.data_antique_list['..key..'])not found') return
	end
	return data
end
-- -------------------antique_list_end---------------------
...
Config.MarketSilverData.data_shop_open_fun = function(key)
	local data=Config.MarketSilverData.data_shop_open[key]
	if DATA_DEBUG and data == nil then
		print('(Config.MarketSilverData.data_shop_open['..key..'])not found') return
	end
	return data
end
-- -------------------shop_open_end---------------------
