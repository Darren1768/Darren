...
-------------通用接口-----------
	...
	, "common.manager.global_audio"
	, "common.manager.view_manager"
	, "common.manager.event_manager"
    , "common.global_reminder"
	, "common.common_define"
	, "common.common_alert"
	, "common.common_alert_yellow"
    , "common.common_reward_alert"
    ...
    , "common.red_manager"
	, "common.player_head"
	, "common.manager.queue_manager"						--队列加载资源,防止一次性加载
...
--------------功能类------------
	...
	--组队模块
	, "game.organizeteam.organizeteam_vo"
	, "game.organizeteam.organizeteam_controller"
	, "game.organizeteam.organizeteam_event"
	, "game.organizeteam.organizeteam_model"
	, "game.organizeteam.organizeteam_const"
	--邮件
	...
	--星命塔模块
	, "game.spirit.spirit_controller"
	, "game.spirit.spirit_event"
	, "game.spirit.spirit_model"
	...
	--联盟部分
	, "game.union.union_controller"
	, "game.union.union_event"
	, "game.union.union_model" 
	, "game.union.union_const"
	--公会宝库
    ...
    -- 灵界
	, "game.ghostdom.ghostdom_controller"
	, "game.ghostdom.ghostdom_event"
	, "game.ghostdom.ghostdom_const"

	-- 探索历练
	, "game.league_explore.league_explore_controller"
	, "game.league_explore.league_explore_event"
	, "game.league_explore.league_explore_const"
	, "game.league_explore.league_explore_model"

    -- 战场
	, "game.battle_field.battle_field_controller"
	, "game.battle_field.battle_field_event"
	, "game.battle_field.battle_field_const"
	-- 边境战
	, "game.battle_border_war.battle_border_war_controller"
	, "game.battle_border_war.battle_border_war_event"
	, "game.battle_border_war.battle_border_war_const"
	, "game.battle_border_war.battle_border_war_model"

	-- 国战
	, "game.battle_national_war.battle_national_war_controller"
	, "game.battle_national_war.battle_national_war_event"
	, "game.battle_national_war.battle_national_war_const"
	, "game.battle_national_war.battle_national_war_model"
...
NewModelFile = {
	...
	-- 关系icon显示用这个
	, ["CommonRelationIconNode"] = 'game.common_ui.view.common_relation_icon_node'
	...
	-- 新神器系统
	, ["NewHallowsMainWindow"] = 'game.hallows.view.new_hallows_main_window'
	, ["NewHallowsMainItem"] = 'game.hallows.view.new_hallows_main_item'
	, ["NewHallowsDialogWindow"] = 'game.hallows.view.new_hallows_dialog_window'
	, ["NewHallowsStudyWindow"] = 'game.hallows.view.new_hallows_study_window'
	, ["NewHallowsDetialNode"] = 'game.hallows.view.new_hallows_detail_node'
	, ["NewHallowsStrengthenNode"] = 'game.hallows.view.new_hallows_strengthen_node'
	, ["NewHallowUpStarNode"] = 'game.hallows.view.new_hallows_starup_node'
	...
	,["topBarPlayerInfo"] ='game.mainui.view.topBarPlayerInfo'
	...
	, ["GuildCreateWindow"] = 'game.guild.view.guild_create_window'

	-- 联盟相关
	, ["UnionInitWindow"] = 'game.union.view.union_init_window'
	, ["UnionMainWindow"] = 'game.union.view.union_main_window'
	, ["UnionCreatePanel"] = 'game.union.view.union_create_panel'
	, ["UnionListPanel"] = 'game.union.view.union_list_panel' 
	, ["UnionRequestItem"] = 'game.union.view.union_request_item'
	, ["UnionSearchPanel"] = 'game.union.view.union_search_panel' 
	, ["UnionListVo"]= 'game.union.union_list_vo' 
	, ["UnionMyInfoVo"] = 'game.union.union_my_info_vo'
	, ["UnionMemberVo"] = 'game.union.union_member_vo' 
	, ["UnionMemberWindow"] = 'game.union.view.union_member_window'
	, ["UnionDonateWindow"] = 'game.union.view.union_donate_window'
	, ["UnionApplyWindow"] = 'game.union.view.union_apply_window'
	, ["UnionApplySetWindow"] = 'game.union.view.union_apply_set_window'
	, ["UnionOperationPostWindow"] = 'game.union.view.union_operation_post_window'
	, ["UnionImpeachPostWindow"] = 'game.union.view.union_impeach_post_window'
	, ["UnionChangeNameWindow"] = 'game.union.view.union_change_name_window' 
	, ["UnionChangeSignWindow"] = 'game.union.view.union_change_sign_window'
	, ["UnionActionGoalWindow"] = 'game.union.view.union_action_goal_window'
	, ["UnionRewardWindow"] = 'game.union.view.union_reward_window'
	, ["UnionSendMailWindow"] = 'game.union.view.union_send_mail_window'
	, ["UnionNoticeWindow"] = 'game.union.view.union_notice_window'
	, ["UnionNoticeVo"] = 'game.union.union_notice_vo'
	, ["UnionNewMainWindow"] = 'game.union.view.union_new_main_window'
	, ["UnionActiveIconWindow"] = 'game.union.view.union_active_icon_window'
	, ["UnionCreateWindow"] = 'game.union.view.union_create_window'

	--领取关系buff
	, ["UnionBuffWindow"] = 'game.union.view.union_buff_window'
	, ["UnionBuffPanel"] = 'game.union.view.union_buff_panel'
	, ["UnionBuffItem"] = 'game.union.view.union_buff_item'
	...
	, ["StoryDrameTalk"] = 'game.story.view.story_drame_talk'
	...
	, ["MainUiView"] = 'game.mainui.view.mainui_view'
	, ["MainUiNoticeView"] = 'game.mainui.view.mainui_notice_view'
	, ["DownloadPanel"] = 'game.mainui.view.download_panel'
    , ["TipButtonsPanel"] = 'game.mainui.view.tip_buttons_panel'
	, ["MainChatUiMsg"] = 'game.mainui.view.mainui_msg'
	...
	--聊天模块
    , ["ChatMainuiPanel"] = 'game.chat.mainui.chat_mainui_panel'
	, ["VoiceRecordUI"] = 'game.chat.view.voice_record_ui'
	, ["ChatWindow"] = 'game.chat.view.chat_window'
	, ["ChatWindowLayer"] = 'game.chat.view.chat_window_layer'
	, ["ChatTabNode"] = 'game.chat.view.chat_tab_node'
	, ["ChatInput"] = 'game.chat.view.chat_input'
    , ["ChatInputNode"] = 'game.chat.view.chat_input_node'
	...
	--竖版星命塔
	, ["SpiritWindow"] = 'game.spirit.view.spirit_window'
	, ["SpiritItem"] = 'game.spirit.view.spirit_item'
	, ["SpiritAwardWindow"] = 'game.spirit.view.spirit_award_window'
	, ["SpiritAwardItem"] = 'game.spirit.view.spirit_award_item'
	, ["SpiritMainWindow"] = 'game.spirit.view.spirit_main_window'
	, ["SpiritVideoWindow"] = 'game.spirit.view.spirit_video_window'
	, ["SpiritResultWindow"] = 'game.spirit.view.spirit_result_window'
	, ["SpiritGetWindow"] = 'game.spirit.view.spirit_get_window'
	, ["SpiritList"] = 'game.spirit.view.spirit_list'
	, ["SpiritTipsWindow"] = 'game.spirit.view.spirit_tips_window'
	...
	, ['HeroMainInfoHeroItem'] = 'game.hero.view.hero_main_info_hero_item'
    ...
    , ['HeroMainTabBodyPanel'] = 'game.hero.view.hero_main_tab_body_panel'
	, ['HeroMainTabTalentPanel'] = 'game.hero.view.hero_main_tab_talent_panel'
    , ['HeroMainTabArtifactsPanel'] = 'game.hero.view.hero_main_tab_artifacts_panel'
	...
	, ['HeroUpgradeStarSkillEffectPanel'] = 'game.hero.view.hero_upgrade_star_skill_effect_panel'
    ...
    , ['SkillPanel'] = 'game.hero.view.skill.skill_panel'
	--布阵 
    ...
    , ['FriendManagerWindow'] = 'game.friend.view.friend_manager_window'
	...
	, ['FriendListItem2'] = 'game.friend.view.friend_list_item2'
	, ['FriendAddPanel'] = 'game.friend.view.friend_add_panel'
	, ["FriendCheckInfoWindow"] = 'game.friend.view.friend_check_info_window'
	, ["FriendGloryWindow"] = "game.friend.view.friend_glory_window"
	
	--组队
	, ['OrganizeTeamMainWindow'] = 'game.organizeteam.view.organizeteam_main_window'
	, ['OrganizeMyTeamPanel'] = 'game.organizeteam.view.organizeteam_myteam_panel'
	, ['OrganizeAddTeamPanel'] = 'game.organizeteam.view.organizeteam_addteam_panel'
	, ['OrganizeGetTeamPanel'] = 'game.organizeteam.view.organizeteam_getteam_panel'
	, ['OrganizeNoticePanel'] = 'game.organizeteam.view.organizeteam_notice_panel'
	, ['OrganizeTeamSelectPanel'] = 'game.organizeteam.view.organizeteam_select_panel'
	, ['OrganizeTeamMeHelpPanel'] = 'game.organizeteam.view.organizeteam_me_help_panel'
	, ['OrganizeTeamHelpMePanel'] = 'game.organizeteam.view.organizeteam_help_me_panel'
	, ['OrganizeTeamFriendHelpWindow'] = 'game.organizeteam.view.organizeteam_friend_help_window'
	, ['OrganizeTeamFriendHelpItem'] = 'game.organizeteam.view.organizeteam_friend_help_item'
	, ['OrganizeTeamFriendHelpItem2'] = 'game.organizeteam.view.organizeteam_friend_help_item_2'
    ...
    , ["BattleCampInfoView"] = 'game.battle.new_view.battle_camp_info_view'
    ...
    -- 灵界
	, ["GhostdomWindow"] = "game.ghostdom.view.ghostdom_window"
	, ["GhostdomBuildItem"] = "game.ghostdom.view.ghostdom_build_item"
    -- 战场
	, ["BattleFieldWindow"] = "game.battle_field.view.battle_field_window"
	, ["BattleFieldMainBuildItem"] = "game.battle_field.view.battle_field_main_build_item"

	-- 边境战
	, ["BattleBorderWarHomeWindow"] = "game.battle_border_war.view.battle_border_war_home_window"
	, ["BattleBorderWarEnemyWindow"] = "game.battle_border_war.view.battle_border_war_enemy_window"
	, ["BattleBorderWarMainBuildItem"] = "game.battle_border_war.view.battle_border_war_main_build_item"
	, ["BattleBorderSpineRenderer"] = "game.battle_border_war.view.battle_border_spine_renderer"

	 -- 国战战
	, ["BattleNationalWarTwoWindow"] = "game.battle_national_war.view.battle_national_war_two_window"
	, ["BattleNationalWarOneWindow"] = "game.battle_national_war.view.battle_national_war_one_window"
	, ["BattleNationalWarNameItem"] = "game.battle_national_war.view.battle_national_war_name_item"
	, ["BattleNationalWarQiZhiItem"] = "game.battle_national_war.view.battle_national_war_qizhi_item"
	, ["BattleNationalSpineRenderer"] = "game.battle_national_war.view.battle_national_spine_renderer"
	, ["BattleNationalWarShowTeam"] = "game.battle_national_war.view.battle_border_war_show_team"
	, ["BattleNationalWarOneResultWindow"] = "game.battle_national_war.view.battle_national_war_one_result_window"
	, ["BattleNationalWarTwoResultWindow"] = "game.battle_national_war.view.battle_national_war_two_result_window"
	, ["BattleNationalWarOneShowInfoWindow"] = "game.battle_national_war.view.battle_national_war_one_showinfo_window"
	, ["BattleNationalWarTwoShowInfoWindow"] = "game.battle_national_war.view.battle_national_war_two_showinfo_window"
	...
	--新加的竞技场
	, ["ArenaLoopMatchWindow1"] = 'game.arena.view.loop.arena_loop_match_window1' 
	...
	, ["ArenaLoopMyLogWindow1"] = 'game.arena.view.loop.arena_loop_my_log_window1'
	, ["ArenaLoopMyLogItem1"] = 'game.arena.view.loop.arena_loop_my_log_item1'
	, ["ArenaLoopChallengePanel1"] = 'game.arena.view.loop.arena_loop_challenge_panel1'
	--新加的竞技场
	...
	--活动
	, ["ActionCommonRewardPanel"] = 'game.action.view.action_common_reward_panel' --通用显示奖励界面 
	...
	, ["EndlessFirstRewardWindow"] = 'game.endless_trail.view.endless_first_reward_window'
	, ["EndlessFirstRewardPanel"] = 'game.endless_trail.view.endless_first_reward_panel'
	...
	, ["ForgehouseTabSelectPanel"] = 'game.forgehouse.view.forgehouse_tab_select_panel'
	...
	-- 探索历练
	, ['LeagueExploreMainWindow'] = 'game.league_explore.view.league_explore_main_window'
	, ['LeagueExploreTeamWindow'] = 'game.league_explore.view.league_explore_team_window'
	, ['LeagueExploreResultWindow'] = 'game.league_explore.view.league_explore_result_window'
	, ['LeagueExploreManagerWindow'] = 'game.league_explore.view.league_explore_manager_window'
	, ['LeagueExploreResourceItem'] = 'game.league_explore.view.league_explore_resource_item'
	, ['LeagueExploreReceiveWindow'] = 'game.league_explore.view.league_explore_receive_window'
	, ['LeagueExploreTeamItem'] = 'game.league_explore.view.league_explore_team_item'
	, ['LeagueExploreSignWindow'] = 'game.league_explore.view.league_explore_sign_window'
	, ['LeagueExploreTeamSelectPanel'] = 'game.league_explore.view.league_explore_team_select_panel'
	, ['LeagueExploreChanllengeResultWindow'] = 'game.league_explore.view.league_explore_chanllenge_result_window'
	, ['LeagueExploreScoreRankWindow'] = 'game.league_explore.view.league_explore_score_rank_window'
	, ['LeagueExploreScoreRankItem'] = 'game.league_explore.view.league_explore_score_rank_item'
	, ['LeagueExploreVideoSelectPanel'] = 'game.league_explore.view.league_explore_video_select_panel'
	...
	, ["Config_SpiritbodyData"] = "config.spiritbody_data"
	, ["Config_PartnerData"] = "config.partner_data"
	...
	, ["Config_SpiritData"] = "config.star_tower_data"
   ...
   ,["Config_HolidayValentineBossData"] = "config.holiday_valentine_boss_data"
	...
	-- 联盟
	, ["Config_UnionData"] = "config.union_data"
	-- 探索历练
	, ["Config_LeagueExploreData"] = "config.league_explore_data"

	-- 支援开放等级
	, ["Config_RelationData"] = "config.relation_data"
}

-- 初始化加载的png
PLIST_LIST = {
	"resource/common/common",
	"resource/common2/common2"
